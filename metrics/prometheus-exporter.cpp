...
td::actor::Task<> PrometheusExporter::collect_and_respond(PayloadPtr payload, double started_at) {
  ...
  stats_->last_collection_duration.set(td::Timestamp::now().at_unix() - started_at);
  co_return {};
}
