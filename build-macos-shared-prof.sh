...
if [ "$with_profile" = true ]; then
  PROFILE_CXX_FLAGS="-fprofile-instr-generate -fcoverage-mapping -g"
fi

cmake -GNinja -DCMAKE_BUILD_TYPE=Debug .. \
  -DCMAKE_CXX_FLAGS="-stdlib=libc++ $PROFILE_CXX_FLAGS -fsanitize=address -fno-omit-frame-pointer -O1 -std=c++20" \
  -DLZ4_FOUND=1 \
