...
class liteServer_accountDispatchQueueInfo;
...
class liteServer_blockOutMsgQueueSize;
...
class liteServer_dispatchQueueInfo;

class liteServer_dispatchQueueMessage;

class liteServer_dispatchQueueMessages;
...
class liteServer_libraryResultWithProof;

class liteServer_lookupBlockResult;

class liteServer_masterchainInfo;

class liteServer_masterchainInfoExt;

class liteServer_outMsgQueueSize;

class liteServer_outMsgQueueSizes;
...
class liteServer_transactionMetadata;
...
class liteServer_nonfinal_candidate;

class liteServer_nonfinal_candidateId;

class liteServer_nonfinal_candidateInfo;

class liteServer_nonfinal_validatorGroupInfo;

class liteServer_nonfinal_validatorGroups;
...
class liteServer_accountDispatchQueueInfo final : public Object {
 public:
  td::Bits256 addr_;
  std::int64_t size_;
  std::int64_t min_lt_;
  ...
  liteServer_accountDispatchQueueInfo();

  liteServer_accountDispatchQueueInfo(td::Bits256 const &addr_, std::int64_t size_, std::int64_t min_lt_, std::int64_t max_lt_);

  static const std::int32_t ID = -1689081157;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_accountDispatchQueueInfo> fetch(td::TlParser &p);

  explicit liteServer_accountDispatchQueueInfo(td::TlParser &p);
...
class liteServer_blockOutMsgQueueSize final : public Object {
 public:
  std::int32_t mode_;
  object_ptr<tonNode_blockIdExt> id_;
  std::int64_t size_;
  td::BufferSlice proof_;
  enum Flags : std::int32_t {PROOF_MASK = 1};

  liteServer_blockOutMsgQueueSize();

  liteServer_blockOutMsgQueueSize(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, std::int64_t size_, td::BufferSlice &&proof_);

  static const std::int32_t ID = -1966227941;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_blockOutMsgQueueSize> fetch(td::TlParser &p);
...
class liteServer_dispatchQueueInfo final : public Object {
 public:
  std::int32_t mode_;
  object_ptr<tonNode_blockIdExt> id_;
  std::vector<object_ptr<liteServer_accountDispatchQueueInfo>> account_dispatch_queues_;
  bool complete_;
  td::BufferSlice proof_;
  enum Flags : std::int32_t {PROOF_MASK = 1};

  liteServer_dispatchQueueInfo();

  liteServer_dispatchQueueInfo(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, std::vector<object_ptr<liteServer_accountDispatchQueueInfo>> &&account_dispatch_queues_, bool complete_, td::BufferSlice &&proof_);

  static const std::int32_t ID = 1561408208;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_dispatchQueueInfo> fetch(td::TlParser &p);
...
class liteServer_dispatchQueueMessage final : public Object {
 public:
  td::Bits256 addr_;
  std::int64_t lt_;
  td::Bits256 hash_;
  object_ptr<liteServer_transactionMetadata> metadata_;

  liteServer_dispatchQueueMessage();

  liteServer_dispatchQueueMessage(td::Bits256 const &addr_, std::int64_t lt_, td::Bits256 const &hash_, object_ptr<liteServer_transactionMetadata> &&metadata_);

  static const std::int32_t ID = -2067520534;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_dispatchQueueMessage> fetch(td::TlParser &p);

  explicit liteServer_dispatchQueueMessage(td::TlParser &p);
...
class liteServer_dispatchQueueMessages final : public Object {
 public:
  std::int32_t mode_;
  object_ptr<tonNode_blockIdExt> id_;
  std::vector<object_ptr<liteServer_dispatchQueueMessage>> messages_;
  bool complete_;
  td::BufferSlice proof_;
  td::BufferSlice messages_boc_;
  enum Flags : std::int32_t {PROOF_MASK = 1, MESSAGES_BOC_MASK = 4};

  liteServer_dispatchQueueMessages();

  liteServer_dispatchQueueMessages(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, std::vector<object_ptr<liteServer_dispatchQueueMessage>> &&messages_, bool complete_, td::BufferSlice &&proof_, td::BufferSlice &&messages_boc_);

  static const std::int32_t ID = 1262516529;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_dispatchQueueMessages> fetch(td::TlParser &p);
...
class liteServer_libraryResultWithProof final : public Object {
 public:
  object_ptr<tonNode_blockIdExt> id_;
  std::int32_t mode_;
  std::vector<object_ptr<liteServer_libraryEntry>> result_;
  ...
  liteServer_libraryResultWithProof(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t mode_, std::vector<object_ptr<liteServer_libraryEntry>> &&result_, td::BufferSlice &&state_proof_, td::BufferSlice &&data_proof_);

  static const std::int32_t ID = 279521215;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_libraryResultWithProof> fetch(td::TlParser &p);
...
class liteServer_lookupBlockResult final : public Object {
 public:
  object_ptr<tonNode_blockIdExt> id_;
  std::int32_t mode_;
  object_ptr<tonNode_blockIdExt> mc_block_id_;
  td::BufferSlice client_mc_state_proof_;
  td::BufferSlice mc_block_proof_;
  std::vector<object_ptr<liteServer_shardBlockLink>> shard_links_;
  td::BufferSlice header_;
  td::BufferSlice prev_header_;

  liteServer_lookupBlockResult();

  liteServer_lookupBlockResult(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&mc_block_id_, td::BufferSlice &&client_mc_state_proof_, td::BufferSlice &&mc_block_proof_, std::vector<object_ptr<liteServer_shardBlockLink>> &&shard_links_, td::BufferSlice &&header_, td::BufferSlice &&prev_header_);

  static const std::int32_t ID = -1720161305;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_lookupBlockResult> fetch(td::TlParser &p);
...
class liteServer_outMsgQueueSize final : public Object {
 public:
  object_ptr<tonNode_blockIdExt> id_;
  std::int32_t size_;

  liteServer_outMsgQueueSize();

  liteServer_outMsgQueueSize(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t size_);

  static const std::int32_t ID = -1480176507;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_outMsgQueueSize> fetch(td::TlParser &p);

  explicit liteServer_outMsgQueueSize(td::TlParser &p);
...
class liteServer_outMsgQueueSizes final : public Object {
 public:
  std::vector<object_ptr<liteServer_outMsgQueueSize>> shards_;
  std::int32_t ext_msg_queue_size_limit_;

  liteServer_outMsgQueueSizes();

  liteServer_outMsgQueueSizes(std::vector<object_ptr<liteServer_outMsgQueueSize>> &&shards_, std::int32_t ext_msg_queue_size_limit_);

  static const std::int32_t ID = -128955901;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_outMsgQueueSizes> fetch(td::TlParser &p);

  explicit liteServer_outMsgQueueSizes(td::TlParser &p);
...
class liteServer_transactionId final : public Object {
 public:
  ...
  td::Bits256 hash_;
  object_ptr<liteServer_transactionMetadata> metadata_;
  enum Flags : std::int32_t {ACCOUNT_MASK = 1, LT_MASK = 2, HASH_MASK = 4, METADATA_MASK = 256};

  liteServer_transactionId();

  liteServer_transactionId(std::int32_t mode_, td::Bits256 const &account_, std::int64_t lt_, td::Bits256 const &hash_, object_ptr<liteServer_transactionMetadata> &&metadata_);
...
class liteServer_transactionMetadata final : public Object {
 public:
  std::int32_t mode_;
  std::int32_t depth_;
  object_ptr<liteServer_accountId> initiator_;
  std::int64_t initiator_lt_;

  liteServer_transactionMetadata();

  liteServer_transactionMetadata(std::int32_t mode_, std::int32_t depth_, object_ptr<liteServer_accountId> &&initiator_, std::int64_t initiator_lt_);

  static const std::int32_t ID = -9411707;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_transactionMetadata> fetch(td::TlParser &p);
...
class liteServer_nonfinal_candidate final : public Object {
 public:
  object_ptr<liteServer_nonfinal_candidateId> id_;
  td::BufferSlice data_;
  td::BufferSlice collated_data_;

  liteServer_nonfinal_candidate();

  liteServer_nonfinal_candidate(object_ptr<liteServer_nonfinal_candidateId> &&id_, td::BufferSlice &&data_, td::BufferSlice &&collated_data_);

  static const std::int32_t ID = -2134686068;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_nonfinal_candidate> fetch(td::TlParser &p);

  explicit liteServer_nonfinal_candidate(td::TlParser &p);
...
class liteServer_nonfinal_candidateId final : public Object {
 public:
  ...
  liteServer_nonfinal_candidateId(object_ptr<tonNode_blockIdExt> &&block_id_, td::Bits256 const &creator_, td::Bits256 const &collated_data_hash_);

  static const std::int32_t ID = 1426358254;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_nonfinal_candidateId> fetch(td::TlParser &p);

  explicit liteServer_nonfinal_candidateId(td::TlParser &p);
...
class liteServer_nonfinal_candidateInfo final : public Object {
 public:
  object_ptr<liteServer_nonfinal_candidateId> id_;
  bool available_;
  ...
  liteServer_nonfinal_candidateInfo(object_ptr<liteServer_nonfinal_candidateId> &&id_, bool available_, std::int64_t approved_weight_, std::int64_t signed_weight_, std::int64_t total_weight_);

  static const std::int32_t ID = 1307312597;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_nonfinal_candidateInfo> fetch(td::TlParser &p);

  explicit liteServer_nonfinal_candidateInfo(td::TlParser &p);
...
class liteServer_nonfinal_validatorGroupInfo final : public Object {
 public:
  object_ptr<tonNode_blockId> next_block_id_;
  std::int32_t cc_seqno_;
  std::vector<object_ptr<tonNode_blockIdExt>> prev_;
  std::vector<object_ptr<liteServer_nonfinal_candidateInfo>> candidates_;

  liteServer_nonfinal_validatorGroupInfo();

  liteServer_nonfinal_validatorGroupInfo(object_ptr<tonNode_blockId> &&next_block_id_, std::int32_t cc_seqno_, std::vector<object_ptr<tonNode_blockIdExt>> &&prev_, std::vector<object_ptr<liteServer_nonfinal_candidateInfo>> &&candidates_);

  static const std::int32_t ID = -103380313;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_nonfinal_validatorGroupInfo> fetch(td::TlParser &p);

  explicit liteServer_nonfinal_validatorGroupInfo(td::TlParser &p);
...
class liteServer_nonfinal_validatorGroups final : public Object {
 public:
  std::vector<object_ptr<liteServer_nonfinal_validatorGroupInfo>> groups_;

  liteServer_nonfinal_validatorGroups();

  explicit liteServer_nonfinal_validatorGroups(std::vector<object_ptr<liteServer_nonfinal_validatorGroupInfo>> &&groups_);

  static const std::int32_t ID = -1928618498;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteServer_nonfinal_validatorGroups> fetch(td::TlParser &p);

  explicit liteServer_nonfinal_validatorGroups(td::TlParser &p);
...
class liteServer_getBlockOutMsgQueueSize final : public Function {
 public:
  std::int32_t mode_;
  object_ptr<tonNode_blockIdExt> id_;
  bool want_proof_;
  enum Flags : std::int32_t {WANT_PROOF_MASK = 1};
  mutable std::int32_t var0;

  liteServer_getBlockOutMsgQueueSize();

  liteServer_getBlockOutMsgQueueSize(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, bool want_proof_);

  static const std::int32_t ID = -1888716935;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<liteServer_blockOutMsgQueueSize>;

  static object_ptr<liteServer_getBlockOutMsgQueueSize> fetch(td::TlParser &p);
...
class liteServer_getDispatchQueueInfo final : public Function {
 public:
  std::int32_t mode_;
  object_ptr<tonNode_blockIdExt> id_;
  td::Bits256 after_addr_;
  std::int32_t max_accounts_;
  bool want_proof_;
  enum Flags : std::int32_t {AFTER_ADDR_MASK = 2, WANT_PROOF_MASK = 1};
  mutable std::int32_t var0;

  liteServer_getDispatchQueueInfo();

  liteServer_getDispatchQueueInfo(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, td::Bits256 const &after_addr_, std::int32_t max_accounts_, bool want_proof_);

  static const std::int32_t ID = 31878131;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<liteServer_dispatchQueueInfo>;

  static object_ptr<liteServer_getDispatchQueueInfo> fetch(td::TlParser &p);
...
class liteServer_getDispatchQueueMessages final : public Function {
 public:
  std::int32_t mode_;
  object_ptr<tonNode_blockIdExt> id_;
  td::Bits256 addr_;
  std::int64_t after_lt_;
  std::int32_t max_messages_;
  bool want_proof_;
  bool one_account_;
  bool messages_boc_;
  enum Flags : std::int32_t {WANT_PROOF_MASK = 1, ONE_ACCOUNT_MASK = 2, MESSAGES_BOC_MASK = 4};
  mutable std::int32_t var0;

  liteServer_getDispatchQueueMessages();

  liteServer_getDispatchQueueMessages(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, td::Bits256 const &addr_, std::int64_t after_lt_, std::int32_t max_messages_, bool want_proof_, bool one_account_, bool messages_boc_);

  static const std::int32_t ID = -1141021639;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<liteServer_dispatchQueueMessages>;

  static object_ptr<liteServer_getDispatchQueueMessages> fetch(td::TlParser &p);
...
class liteServer_getLibrariesWithProof final : public Function {
 public:
  object_ptr<tonNode_blockIdExt> id_;
  std::int32_t mode_;
  std::vector<td::Bits256> library_list_;
  ...
  liteServer_getLibrariesWithProof(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t mode_, std::vector<td::Bits256> &&library_list_);

  static const std::int32_t ID = -646540355;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<liteServer_libraryResultWithProof>;

  static object_ptr<liteServer_getLibrariesWithProof> fetch(td::TlParser &p);
...
class liteServer_getOutMsgQueueSizes final : public Function {
 public:
  std::int32_t mode_;
  std::int32_t wc_;
  std::int64_t shard_;
  enum Flags : std::int32_t {WC_MASK = 1, SHARD_MASK = 1};
  mutable std::int32_t var0;

  liteServer_getOutMsgQueueSizes();

  liteServer_getOutMsgQueueSizes(std::int32_t mode_, std::int32_t wc_, std::int64_t shard_);

  static const std::int32_t ID = 2076286006;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<liteServer_outMsgQueueSizes>;

  static object_ptr<liteServer_getOutMsgQueueSizes> fetch(td::TlParser &p);
...
class liteServer_lookupBlockWithProof final : public Function {
 public:
  std::int32_t mode_;
  object_ptr<tonNode_blockId> id_;
  object_ptr<tonNode_blockIdExt> mc_block_id_;
  ...
  liteServer_lookupBlockWithProof(std::int32_t mode_, object_ptr<tonNode_blockId> &&id_, object_ptr<tonNode_blockIdExt> &&mc_block_id_, std::int64_t lt_, std::int32_t utime_);

  static const std::int32_t ID = -1677434888;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<liteServer_lookupBlockResult>;

  static object_ptr<liteServer_lookupBlockWithProof> fetch(td::TlParser &p);
...
class liteServer_nonfinal_getCandidate final : public Function {
 public:
  object_ptr<liteServer_nonfinal_candidateId> id_;

  liteServer_nonfinal_getCandidate();

  explicit liteServer_nonfinal_getCandidate(object_ptr<liteServer_nonfinal_candidateId> &&id_);

  static const std::int32_t ID = 805803230;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<liteServer_nonfinal_candidate>;

  static object_ptr<liteServer_nonfinal_getCandidate> fetch(td::TlParser &p);

  explicit liteServer_nonfinal_getCandidate(td::TlParser &p);
...
class liteServer_nonfinal_getValidatorGroups final : public Function {
 public:
  std::int32_t mode_;
  std::int32_t wc_;
  std::int64_t shard_;
  ...
  liteServer_nonfinal_getValidatorGroups(std::int32_t mode_, std::int32_t wc_, std::int64_t shard_);

  static const std::int32_t ID = -1516694045;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<liteServer_nonfinal_validatorGroups>;

  static object_ptr<liteServer_nonfinal_getValidatorGroups> fetch(td::TlParser &p);
