...
#define FAIL(error) p.set_error(error); return nullptr;
  ...
  switch (constructor) {
    ...
    case liteServer_accountDispatchQueueInfo::ID:
      return liteServer_accountDispatchQueueInfo::fetch(p);
    ...
    case liteServer_blockOutMsgQueueSize::ID:
      return liteServer_blockOutMsgQueueSize::fetch(p);
    ...
    case liteServer_dispatchQueueInfo::ID:
      return liteServer_dispatchQueueInfo::fetch(p);
    case liteServer_dispatchQueueMessage::ID:
      return liteServer_dispatchQueueMessage::fetch(p);
    case liteServer_dispatchQueueMessages::ID:
      return liteServer_dispatchQueueMessages::fetch(p);
    ...
    case liteServer_libraryResultWithProof::ID:
      return liteServer_libraryResultWithProof::fetch(p);
    case liteServer_lookupBlockResult::ID:
      return liteServer_lookupBlockResult::fetch(p);
    ...
    case liteServer_outMsgQueueSize::ID:
      return liteServer_outMsgQueueSize::fetch(p);
    case liteServer_outMsgQueueSizes::ID:
      return liteServer_outMsgQueueSizes::fetch(p);
    ...
    case liteServer_transactionMetadata::ID:
      return liteServer_transactionMetadata::fetch(p);
    ...
    case liteServer_nonfinal_candidate::ID:
      return liteServer_nonfinal_candidate::fetch(p);
    case liteServer_nonfinal_candidateId::ID:
      return liteServer_nonfinal_candidateId::fetch(p);
    case liteServer_nonfinal_candidateInfo::ID:
      return liteServer_nonfinal_candidateInfo::fetch(p);
    case liteServer_nonfinal_validatorGroupInfo::ID:
      return liteServer_nonfinal_validatorGroupInfo::fetch(p);
    case liteServer_nonfinal_validatorGroups::ID:
      return liteServer_nonfinal_validatorGroups::fetch(p);
...
#define FAIL(error) p.set_error(error); return nullptr;
  ...
  switch (constructor) {
    ...
    case liteServer_getBlockOutMsgQueueSize::ID:
      return liteServer_getBlockOutMsgQueueSize::fetch(p);
    ...
    case liteServer_getDispatchQueueInfo::ID:
      return liteServer_getDispatchQueueInfo::fetch(p);
    case liteServer_getDispatchQueueMessages::ID:
      return liteServer_getDispatchQueueMessages::fetch(p);
    case liteServer_getLibraries::ID:
      return liteServer_getLibraries::fetch(p);
    case liteServer_getLibrariesWithProof::ID:
      return liteServer_getLibrariesWithProof::fetch(p);
    ...
    case liteServer_getOutMsgQueueSizes::ID:
      return liteServer_getOutMsgQueueSizes::fetch(p);
    ...
    case liteServer_lookupBlockWithProof::ID:
      return liteServer_lookupBlockWithProof::fetch(p);
    case liteServer_nonfinal_getCandidate::ID:
      return liteServer_nonfinal_getCandidate::fetch(p);
    case liteServer_nonfinal_getValidatorGroups::ID:
      return liteServer_nonfinal_getValidatorGroups::fetch(p);
...
liteServer_accountDispatchQueueInfo::liteServer_accountDispatchQueueInfo()
  : addr_()
  , size_()
  , min_lt_()
  , max_lt_()
...
liteServer_accountDispatchQueueInfo::liteServer_accountDispatchQueueInfo(td::Bits256 const &addr_, std::int64_t size_, std::int64_t min_lt_, std::int64_t max_lt_)
  : addr_(addr_)
  , size_(size_)
  , min_lt_(min_lt_)
  , max_lt_(max_lt_)
...
const std::int32_t liteServer_accountDispatchQueueInfo::ID;

object_ptr<liteServer_accountDispatchQueueInfo> liteServer_accountDispatchQueueInfo::fetch(td::TlParser &p) {
  return make_object<liteServer_accountDispatchQueueInfo>(p);
}

liteServer_accountDispatchQueueInfo::liteServer_accountDispatchQueueInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : addr_(TlFetchInt256::parse(p))
  , size_(TlFetchLong::parse(p))
  , min_lt_(TlFetchLong::parse(p))
  , max_lt_(TlFetchLong::parse(p))
#undef FAIL
{}

void liteServer_accountDispatchQueueInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(addr_, s);
  TlStoreBinary::store(size_, s);
  TlStoreBinary::store(min_lt_, s);
  TlStoreBinary::store(max_lt_, s);
}

void liteServer_accountDispatchQueueInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(addr_, s);
  TlStoreBinary::store(size_, s);
  TlStoreBinary::store(min_lt_, s);
...
void liteServer_accountDispatchQueueInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_accountDispatchQueueInfo");
    s.store_field("addr", addr_);
    s.store_field("size", size_);
    s.store_field("min_lt", min_lt_);
    s.store_field("max_lt", max_lt_);
    s.store_class_end();
  }
}
...
liteServer_blockOutMsgQueueSize::liteServer_blockOutMsgQueueSize()
  : mode_()
  , id_()
  , size_()
  , proof_()
...
liteServer_blockOutMsgQueueSize::liteServer_blockOutMsgQueueSize(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, std::int64_t size_, td::BufferSlice &&proof_)
  : mode_(mode_)
  , id_(std::move(id_))
  , size_(size_)
  , proof_(std::move(proof_))
...
const std::int32_t liteServer_blockOutMsgQueueSize::ID;

object_ptr<liteServer_blockOutMsgQueueSize> liteServer_blockOutMsgQueueSize::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_blockOutMsgQueueSize> res = make_object<liteServer_blockOutMsgQueueSize>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
...
void liteServer_blockOutMsgQueueSize::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
...
void liteServer_blockOutMsgQueueSize::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
...
void liteServer_blockOutMsgQueueSize::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_blockOutMsgQueueSize");
  std::int32_t var0;
    s.store_field("mode", (var0 = mode_));
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_field("size", size_);
...
liteServer_dispatchQueueInfo::liteServer_dispatchQueueInfo()
  : mode_()
  , id_()
  , account_dispatch_queues_()
  , complete_()
  , proof_()
{}

liteServer_dispatchQueueInfo::liteServer_dispatchQueueInfo(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, std::vector<object_ptr<liteServer_accountDispatchQueueInfo>> &&account_dispatch_queues_, bool complete_, td::BufferSlice &&proof_)
  : mode_(mode_)
  , id_(std::move(id_))
  , account_dispatch_queues_(std::move(account_dispatch_queues_))
  , complete_(complete_)
  , proof_(std::move(proof_))
{}

const std::int32_t liteServer_dispatchQueueInfo::ID;

object_ptr<liteServer_dispatchQueueInfo> liteServer_dispatchQueueInfo::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_dispatchQueueInfo> res = make_object<liteServer_dispatchQueueInfo>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
  res->account_dispatch_queues_ = TlFetchVector<TlFetchObject<liteServer_accountDispatchQueueInfo>>::parse(p);
...
void liteServer_dispatchQueueInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
  TlStoreVector<TlStoreObject>::store(account_dispatch_queues_, s);
  TlStoreBool::store(complete_, s);
  if (var0 & 1) { TlStoreString::store(proof_, s); }
}

void liteServer_dispatchQueueInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
...
void liteServer_dispatchQueueInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_dispatchQueueInfo");
  std::int32_t var0;
    s.store_field("mode", (var0 = mode_));
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    { const std::vector<object_ptr<liteServer_accountDispatchQueueInfo>> &v = account_dispatch_queues_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("account_dispatch_queues", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
...
liteServer_dispatchQueueMessage::liteServer_dispatchQueueMessage()
  : addr_()
  , lt_()
  , hash_()
  , metadata_()
...
liteServer_dispatchQueueMessage::liteServer_dispatchQueueMessage(td::Bits256 const &addr_, std::int64_t lt_, td::Bits256 const &hash_, object_ptr<liteServer_transactionMetadata> &&metadata_)
  : addr_(addr_)
  , lt_(lt_)
  , hash_(hash_)
...
const std::int32_t liteServer_dispatchQueueMessage::ID;

object_ptr<liteServer_dispatchQueueMessage> liteServer_dispatchQueueMessage::fetch(td::TlParser &p) {
  return make_object<liteServer_dispatchQueueMessage>(p);
}

liteServer_dispatchQueueMessage::liteServer_dispatchQueueMessage(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : addr_(TlFetchInt256::parse(p))
  , lt_(TlFetchLong::parse(p))
  , hash_(TlFetchInt256::parse(p))
  , metadata_(TlFetchObject<liteServer_transactionMetadata>::parse(p))
#undef FAIL
{}

void liteServer_dispatchQueueMessage::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(addr_, s);
  TlStoreBinary::store(lt_, s);
  TlStoreBinary::store(hash_, s);
  TlStoreObject::store(metadata_, s);
}

void liteServer_dispatchQueueMessage::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(addr_, s);
  TlStoreBinary::store(lt_, s);
  TlStoreBinary::store(hash_, s);
...
void liteServer_dispatchQueueMessage::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_dispatchQueueMessage");
    s.store_field("addr", addr_);
    s.store_field("lt", lt_);
    s.store_field("hash", hash_);
    if (metadata_ == nullptr) { s.store_field("metadata", "null"); } else { metadata_->store(s, "metadata"); }
    s.store_class_end();
  }
}

liteServer_dispatchQueueMessages::liteServer_dispatchQueueMessages()
  : mode_()
  , id_()
  , messages_()
  , complete_()
...
liteServer_dispatchQueueMessages::liteServer_dispatchQueueMessages(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, std::vector<object_ptr<liteServer_dispatchQueueMessage>> &&messages_, bool complete_, td::BufferSlice &&proof_, td::BufferSlice &&messages_boc_)
  : mode_(mode_)
  , id_(std::move(id_))
  , messages_(std::move(messages_))
  , complete_(complete_)
  , proof_(std::move(proof_))
  , messages_boc_(std::move(messages_boc_))
{}

const std::int32_t liteServer_dispatchQueueMessages::ID;

object_ptr<liteServer_dispatchQueueMessages> liteServer_dispatchQueueMessages::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_dispatchQueueMessages> res = make_object<liteServer_dispatchQueueMessages>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
  res->messages_ = TlFetchVector<TlFetchObject<liteServer_dispatchQueueMessage>>::parse(p);
  res->complete_ = TlFetchBool::parse(p);
  if (var0 & 1) { res->proof_ = TlFetchBytes<td::BufferSlice>::parse(p); }
  if (var0 & 4) { res->messages_boc_ = TlFetchBytes<td::BufferSlice>::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void liteServer_dispatchQueueMessages::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
  TlStoreVector<TlStoreObject>::store(messages_, s);
  TlStoreBool::store(complete_, s);
  if (var0 & 1) { TlStoreString::store(proof_, s); }
  if (var0 & 4) { TlStoreString::store(messages_boc_, s); }
}

void liteServer_dispatchQueueMessages::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
...
void liteServer_dispatchQueueMessages::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_dispatchQueueMessages");
  std::int32_t var0;
    s.store_field("mode", (var0 = mode_));
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    { const std::vector<object_ptr<liteServer_dispatchQueueMessage>> &v = messages_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("messages", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_field("complete", complete_);
    if (var0 & 1) { s.store_bytes_field("proof", proof_); }
    if (var0 & 4) { s.store_bytes_field("messages_boc", messages_boc_); }
    s.store_class_end();
  }
}
...
liteServer_libraryResultWithProof::liteServer_libraryResultWithProof()
  : id_()
  , mode_()
  , result_()
  , state_proof_()
...
liteServer_libraryResultWithProof::liteServer_libraryResultWithProof(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t mode_, std::vector<object_ptr<liteServer_libraryEntry>> &&result_, td::BufferSlice &&state_proof_, td::BufferSlice &&data_proof_)
  : id_(std::move(id_))
  , mode_(mode_)
  , result_(std::move(result_))
  , state_proof_(std::move(state_proof_))
...
const std::int32_t liteServer_libraryResultWithProof::ID;

object_ptr<liteServer_libraryResultWithProof> liteServer_libraryResultWithProof::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_libraryResultWithProof> res = make_object<liteServer_libraryResultWithProof>();
  std::int32_t var0;
  res->id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->result_ = TlFetchVector<TlFetchObject<liteServer_libraryEntry>>::parse(p);
  res->state_proof_ = TlFetchBytes<td::BufferSlice>::parse(p);
...
void liteServer_libraryResultWithProof::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreObject::store(id_, s);
  TlStoreBinary::store((var0 = mode_), s);
...
void liteServer_libraryResultWithProof::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreObject::store(id_, s);
  TlStoreBinary::store((var0 = mode_), s);
...
void liteServer_libraryResultWithProof::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_libraryResultWithProof");
  std::int32_t var0;
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_field("mode", (var0 = mode_));
    { const std::vector<object_ptr<liteServer_libraryEntry>> &v = result_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("result", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
...
liteServer_lookupBlockResult::liteServer_lookupBlockResult()
  : id_()
  , mode_()
  , mc_block_id_()
  , client_mc_state_proof_()
  , mc_block_proof_()
  , shard_links_()
  , header_()
  , prev_header_()
...
liteServer_lookupBlockResult::liteServer_lookupBlockResult(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&mc_block_id_, td::BufferSlice &&client_mc_state_proof_, td::BufferSlice &&mc_block_proof_, std::vector<object_ptr<liteServer_shardBlockLink>> &&shard_links_, td::BufferSlice &&header_, td::BufferSlice &&prev_header_)
  : id_(std::move(id_))
  , mode_(mode_)
  , mc_block_id_(std::move(mc_block_id_))
  , client_mc_state_proof_(std::move(client_mc_state_proof_))
  , mc_block_proof_(std::move(mc_block_proof_))
  , shard_links_(std::move(shard_links_))
  , header_(std::move(header_))
  , prev_header_(std::move(prev_header_))
{}

const std::int32_t liteServer_lookupBlockResult::ID;

object_ptr<liteServer_lookupBlockResult> liteServer_lookupBlockResult::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_lookupBlockResult> res = make_object<liteServer_lookupBlockResult>();
  std::int32_t var0;
  res->id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->mc_block_id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
  res->client_mc_state_proof_ = TlFetchBytes<td::BufferSlice>::parse(p);
  res->mc_block_proof_ = TlFetchBytes<td::BufferSlice>::parse(p);
  res->shard_links_ = TlFetchVector<TlFetchObject<liteServer_shardBlockLink>>::parse(p);
  res->header_ = TlFetchBytes<td::BufferSlice>::parse(p);
  res->prev_header_ = TlFetchBytes<td::BufferSlice>::parse(p);
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void liteServer_lookupBlockResult::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreObject::store(id_, s);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(mc_block_id_, s);
  TlStoreString::store(client_mc_state_proof_, s);
  TlStoreString::store(mc_block_proof_, s);
  TlStoreVector<TlStoreObject>::store(shard_links_, s);
  TlStoreString::store(header_, s);
  TlStoreString::store(prev_header_, s);
}

void liteServer_lookupBlockResult::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreObject::store(id_, s);
  TlStoreBinary::store((var0 = mode_), s);
...
void liteServer_lookupBlockResult::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_lookupBlockResult");
  std::int32_t var0;
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_field("mode", (var0 = mode_));
    if (mc_block_id_ == nullptr) { s.store_field("mc_block_id", "null"); } else { mc_block_id_->store(s, "mc_block_id"); }
    s.store_bytes_field("client_mc_state_proof", client_mc_state_proof_);
    s.store_bytes_field("mc_block_proof", mc_block_proof_);
    { const std::vector<object_ptr<liteServer_shardBlockLink>> &v = shard_links_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("shard_links", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_bytes_field("header", header_);
    s.store_bytes_field("prev_header", prev_header_);
    s.store_class_end();
  }
}
...
liteServer_outMsgQueueSize::liteServer_outMsgQueueSize()
  : id_()
  , size_()
{}

liteServer_outMsgQueueSize::liteServer_outMsgQueueSize(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t size_)
  : id_(std::move(id_))
  , size_(size_)
{}

const std::int32_t liteServer_outMsgQueueSize::ID;

object_ptr<liteServer_outMsgQueueSize> liteServer_outMsgQueueSize::fetch(td::TlParser &p) {
  return make_object<liteServer_outMsgQueueSize>(p);
}

liteServer_outMsgQueueSize::liteServer_outMsgQueueSize(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : id_(TlFetchObject<tonNode_blockIdExt>::parse(p))
...
void liteServer_outMsgQueueSize::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreObject::store(id_, s);
  TlStoreBinary::store(size_, s);
}

void liteServer_outMsgQueueSize::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreObject::store(id_, s);
  TlStoreBinary::store(size_, s);
}

void liteServer_outMsgQueueSize::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_outMsgQueueSize");
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_field("size", size_);
    s.store_class_end();
  }
...
liteServer_outMsgQueueSizes::liteServer_outMsgQueueSizes()
  : shards_()
  , ext_msg_queue_size_limit_()
{}

liteServer_outMsgQueueSizes::liteServer_outMsgQueueSizes(std::vector<object_ptr<liteServer_outMsgQueueSize>> &&shards_, std::int32_t ext_msg_queue_size_limit_)
  : shards_(std::move(shards_))
  , ext_msg_queue_size_limit_(ext_msg_queue_size_limit_)
{}

const std::int32_t liteServer_outMsgQueueSizes::ID;

object_ptr<liteServer_outMsgQueueSizes> liteServer_outMsgQueueSizes::fetch(td::TlParser &p) {
  return make_object<liteServer_outMsgQueueSizes>(p);
}

liteServer_outMsgQueueSizes::liteServer_outMsgQueueSizes(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : shards_(TlFetchVector<TlFetchObject<liteServer_outMsgQueueSize>>::parse(p))
  , ext_msg_queue_size_limit_(TlFetchInt::parse(p))
#undef FAIL
{}

void liteServer_outMsgQueueSizes::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(shards_, s);
  TlStoreBinary::store(ext_msg_queue_size_limit_, s);
}

void liteServer_outMsgQueueSizes::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(shards_, s);
  TlStoreBinary::store(ext_msg_queue_size_limit_, s);
}

void liteServer_outMsgQueueSizes::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_outMsgQueueSizes");
    { const std::vector<object_ptr<liteServer_outMsgQueueSize>> &v = shards_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("shards", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_field("ext_msg_queue_size_limit", ext_msg_queue_size_limit_);
    s.store_class_end();
  }
}
...
liteServer_transactionId::liteServer_transactionId(std::int32_t mode_, td::Bits256 const &account_, std::int64_t lt_, td::Bits256 const &hash_, object_ptr<liteServer_transactionMetadata> &&metadata_)
  : mode_(mode_)
  , account_(account_)
  , lt_(lt_)
  , hash_(hash_)
...
#define FAIL(error) p.set_error(error); return nullptr;
  ...
  if (var0 & 256) { res->metadata_ = TlFetchObject<liteServer_transactionMetadata>::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}
...
void liteServer_transactionId::store(td::TlStorerCalcLength &s) const {
  ...
  if (var0 & 256) { TlStoreObject::store(metadata_, s); }
}
...
void liteServer_transactionId::store(td::TlStorerToString &s, const char *field_name) const {
  ...
  std::int32_t var0;
    ...
    if (var0 & 256) { if (metadata_ == nullptr) { s.store_field("metadata", "null"); } else { metadata_->store(s, "metadata"); } }
    s.store_class_end();
  }
}
...
liteServer_transactionMetadata::liteServer_transactionMetadata()
  : mode_()
  , depth_()
  , initiator_()
  , initiator_lt_()
...
liteServer_transactionMetadata::liteServer_transactionMetadata(std::int32_t mode_, std::int32_t depth_, object_ptr<liteServer_accountId> &&initiator_, std::int64_t initiator_lt_)
  : mode_(mode_)
  , depth_(depth_)
  , initiator_(std::move(initiator_))
  , initiator_lt_(initiator_lt_)
{}

const std::int32_t liteServer_transactionMetadata::ID;

object_ptr<liteServer_transactionMetadata> liteServer_transactionMetadata::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_transactionMetadata> res = make_object<liteServer_transactionMetadata>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->depth_ = TlFetchInt::parse(p);
  res->initiator_ = TlFetchObject<liteServer_accountId>::parse(p);
  res->initiator_lt_ = TlFetchLong::parse(p);
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void liteServer_transactionMetadata::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreBinary::store(depth_, s);
  TlStoreObject::store(initiator_, s);
  TlStoreBinary::store(initiator_lt_, s);
}

void liteServer_transactionMetadata::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreBinary::store(depth_, s);
...
void liteServer_transactionMetadata::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_transactionMetadata");
  std::int32_t var0;
    s.store_field("mode", (var0 = mode_));
    s.store_field("depth", depth_);
    if (initiator_ == nullptr) { s.store_field("initiator", "null"); } else { initiator_->store(s, "initiator"); }
    s.store_field("initiator_lt", initiator_lt_);
    s.store_class_end();
  }
}
...
liteServer_nonfinal_candidate::liteServer_nonfinal_candidate()
  : id_()
  , data_()
  , collated_data_()
{}

liteServer_nonfinal_candidate::liteServer_nonfinal_candidate(object_ptr<liteServer_nonfinal_candidateId> &&id_, td::BufferSlice &&data_, td::BufferSlice &&collated_data_)
  : id_(std::move(id_))
  , data_(std::move(data_))
  , collated_data_(std::move(collated_data_))
{}

const std::int32_t liteServer_nonfinal_candidate::ID;

object_ptr<liteServer_nonfinal_candidate> liteServer_nonfinal_candidate::fetch(td::TlParser &p) {
  return make_object<liteServer_nonfinal_candidate>(p);
}

liteServer_nonfinal_candidate::liteServer_nonfinal_candidate(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : id_(TlFetchObject<liteServer_nonfinal_candidateId>::parse(p))
  , data_(TlFetchBytes<td::BufferSlice>::parse(p))
  , collated_data_(TlFetchBytes<td::BufferSlice>::parse(p))
#undef FAIL
{}

void liteServer_nonfinal_candidate::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreObject::store(id_, s);
  TlStoreString::store(data_, s);
...
void liteServer_nonfinal_candidate::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreObject::store(id_, s);
  TlStoreString::store(data_, s);
  TlStoreString::store(collated_data_, s);
...
void liteServer_nonfinal_candidate::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_nonfinal_candidate");
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_bytes_field("data", data_);
...
liteServer_nonfinal_candidateId::liteServer_nonfinal_candidateId()
  : block_id_()
  , creator_()
  , collated_data_hash_()
{}

liteServer_nonfinal_candidateId::liteServer_nonfinal_candidateId(object_ptr<tonNode_blockIdExt> &&block_id_, td::Bits256 const &creator_, td::Bits256 const &collated_data_hash_)
  : block_id_(std::move(block_id_))
  , creator_(creator_)
  , collated_data_hash_(collated_data_hash_)
{}

const std::int32_t liteServer_nonfinal_candidateId::ID;

object_ptr<liteServer_nonfinal_candidateId> liteServer_nonfinal_candidateId::fetch(td::TlParser &p) {
  return make_object<liteServer_nonfinal_candidateId>(p);
}

liteServer_nonfinal_candidateId::liteServer_nonfinal_candidateId(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : block_id_(TlFetchObject<tonNode_blockIdExt>::parse(p))
  , creator_(TlFetchInt256::parse(p))
  , collated_data_hash_(TlFetchInt256::parse(p))
#undef FAIL
{}

void liteServer_nonfinal_candidateId::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreObject::store(block_id_, s);
  TlStoreBinary::store(creator_, s);
  TlStoreBinary::store(collated_data_hash_, s);
}

void liteServer_nonfinal_candidateId::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreObject::store(block_id_, s);
  TlStoreBinary::store(creator_, s);
  TlStoreBinary::store(collated_data_hash_, s);
...
void liteServer_nonfinal_candidateId::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_nonfinal_candidateId");
    if (block_id_ == nullptr) { s.store_field("block_id", "null"); } else { block_id_->store(s, "block_id"); }
    s.store_field("creator", creator_);
    s.store_field("collated_data_hash", collated_data_hash_);
    s.store_class_end();
  }
}

liteServer_nonfinal_candidateInfo::liteServer_nonfinal_candidateInfo()
  : id_()
  , available_()
  , approved_weight_()
  , signed_weight_()
...
liteServer_nonfinal_candidateInfo::liteServer_nonfinal_candidateInfo(object_ptr<liteServer_nonfinal_candidateId> &&id_, bool available_, std::int64_t approved_weight_, std::int64_t signed_weight_, std::int64_t total_weight_)
  : id_(std::move(id_))
  , available_(available_)
  , approved_weight_(approved_weight_)
  , signed_weight_(signed_weight_)
  , total_weight_(total_weight_)
{}

const std::int32_t liteServer_nonfinal_candidateInfo::ID;

object_ptr<liteServer_nonfinal_candidateInfo> liteServer_nonfinal_candidateInfo::fetch(td::TlParser &p) {
  return make_object<liteServer_nonfinal_candidateInfo>(p);
}

liteServer_nonfinal_candidateInfo::liteServer_nonfinal_candidateInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : id_(TlFetchObject<liteServer_nonfinal_candidateId>::parse(p))
  , available_(TlFetchBool::parse(p))
  , approved_weight_(TlFetchLong::parse(p))
  , signed_weight_(TlFetchLong::parse(p))
  , total_weight_(TlFetchLong::parse(p))
#undef FAIL
{}

void liteServer_nonfinal_candidateInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreObject::store(id_, s);
  TlStoreBool::store(available_, s);
  TlStoreBinary::store(approved_weight_, s);
  TlStoreBinary::store(signed_weight_, s);
  TlStoreBinary::store(total_weight_, s);
}

void liteServer_nonfinal_candidateInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreObject::store(id_, s);
  TlStoreBool::store(available_, s);
  TlStoreBinary::store(approved_weight_, s);
...
void liteServer_nonfinal_candidateInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_nonfinal_candidateInfo");
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_field("available", available_);
    s.store_field("approved_weight", approved_weight_);
    s.store_field("signed_weight", signed_weight_);
    s.store_field("total_weight", total_weight_);
    s.store_class_end();
  }
}

liteServer_nonfinal_validatorGroupInfo::liteServer_nonfinal_validatorGroupInfo()
  : next_block_id_()
  , cc_seqno_()
  , prev_()
  , candidates_()
...
liteServer_nonfinal_validatorGroupInfo::liteServer_nonfinal_validatorGroupInfo(object_ptr<tonNode_blockId> &&next_block_id_, std::int32_t cc_seqno_, std::vector<object_ptr<tonNode_blockIdExt>> &&prev_, std::vector<object_ptr<liteServer_nonfinal_candidateInfo>> &&candidates_)
  : next_block_id_(std::move(next_block_id_))
  , cc_seqno_(cc_seqno_)
  , prev_(std::move(prev_))
  , candidates_(std::move(candidates_))
{}

const std::int32_t liteServer_nonfinal_validatorGroupInfo::ID;

object_ptr<liteServer_nonfinal_validatorGroupInfo> liteServer_nonfinal_validatorGroupInfo::fetch(td::TlParser &p) {
  return make_object<liteServer_nonfinal_validatorGroupInfo>(p);
}

liteServer_nonfinal_validatorGroupInfo::liteServer_nonfinal_validatorGroupInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : next_block_id_(TlFetchObject<tonNode_blockId>::parse(p))
  , cc_seqno_(TlFetchInt::parse(p))
  , prev_(TlFetchVector<TlFetchObject<tonNode_blockIdExt>>::parse(p))
  , candidates_(TlFetchVector<TlFetchObject<liteServer_nonfinal_candidateInfo>>::parse(p))
#undef FAIL
{}

void liteServer_nonfinal_validatorGroupInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreObject::store(next_block_id_, s);
  TlStoreBinary::store(cc_seqno_, s);
  TlStoreVector<TlStoreObject>::store(prev_, s);
  TlStoreVector<TlStoreObject>::store(candidates_, s);
}

void liteServer_nonfinal_validatorGroupInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreObject::store(next_block_id_, s);
  TlStoreBinary::store(cc_seqno_, s);
  TlStoreVector<TlStoreObject>::store(prev_, s);
...
void liteServer_nonfinal_validatorGroupInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_nonfinal_validatorGroupInfo");
    if (next_block_id_ == nullptr) { s.store_field("next_block_id", "null"); } else { next_block_id_->store(s, "next_block_id"); }
    ...
    { const std::vector<object_ptr<liteServer_nonfinal_candidateInfo>> &v = candidates_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("candidates", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}

liteServer_nonfinal_validatorGroups::liteServer_nonfinal_validatorGroups()
  : groups_()
{}

liteServer_nonfinal_validatorGroups::liteServer_nonfinal_validatorGroups(std::vector<object_ptr<liteServer_nonfinal_validatorGroupInfo>> &&groups_)
  : groups_(std::move(groups_))
{}

const std::int32_t liteServer_nonfinal_validatorGroups::ID;

object_ptr<liteServer_nonfinal_validatorGroups> liteServer_nonfinal_validatorGroups::fetch(td::TlParser &p) {
  return make_object<liteServer_nonfinal_validatorGroups>(p);
}

liteServer_nonfinal_validatorGroups::liteServer_nonfinal_validatorGroups(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : groups_(TlFetchVector<TlFetchObject<liteServer_nonfinal_validatorGroupInfo>>::parse(p))
#undef FAIL
{}

void liteServer_nonfinal_validatorGroups::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(groups_, s);
}

void liteServer_nonfinal_validatorGroups::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(groups_, s);
}

void liteServer_nonfinal_validatorGroups::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_nonfinal_validatorGroups");
    { const std::vector<object_ptr<liteServer_nonfinal_validatorGroupInfo>> &v = groups_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("groups", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}
...
liteServer_getBlockOutMsgQueueSize::liteServer_getBlockOutMsgQueueSize()
  : mode_()
  , id_()
  , want_proof_()
{}

liteServer_getBlockOutMsgQueueSize::liteServer_getBlockOutMsgQueueSize(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, bool want_proof_)
  : mode_(mode_)
  , id_(std::move(id_))
  , want_proof_(want_proof_)
{}

const std::int32_t liteServer_getBlockOutMsgQueueSize::ID;

object_ptr<liteServer_getBlockOutMsgQueueSize> liteServer_getBlockOutMsgQueueSize::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_getBlockOutMsgQueueSize> res = make_object<liteServer_getBlockOutMsgQueueSize>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
  if (var0 & 1) { res->want_proof_ = TlFetchTrue::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void liteServer_getBlockOutMsgQueueSize::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1888716935);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
  if (var0 & 1) { TlStoreTrue::store(want_proof_, s); }
}

void liteServer_getBlockOutMsgQueueSize::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1888716935);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
...
void liteServer_getBlockOutMsgQueueSize::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_getBlockOutMsgQueueSize");
    s.store_field("mode", (var0 = mode_));
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    if (var0 & 1) {  }
    s.store_class_end();
...
liteServer_getBlockOutMsgQueueSize::ReturnType liteServer_getBlockOutMsgQueueSize::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<liteServer_blockOutMsgQueueSize>, -1966227941>::parse(p);
#undef FAIL
}
...
liteServer_getDispatchQueueInfo::liteServer_getDispatchQueueInfo()
  : mode_()
  , id_()
  , after_addr_()
  , max_accounts_()
...
liteServer_getDispatchQueueInfo::liteServer_getDispatchQueueInfo(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, td::Bits256 const &after_addr_, std::int32_t max_accounts_, bool want_proof_)
  : mode_(mode_)
  , id_(std::move(id_))
  , after_addr_(after_addr_)
  , max_accounts_(max_accounts_)
  , want_proof_(want_proof_)
{}

const std::int32_t liteServer_getDispatchQueueInfo::ID;

object_ptr<liteServer_getDispatchQueueInfo> liteServer_getDispatchQueueInfo::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_getDispatchQueueInfo> res = make_object<liteServer_getDispatchQueueInfo>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
  if (var0 & 2) { res->after_addr_ = TlFetchInt256::parse(p); }
  res->max_accounts_ = TlFetchInt::parse(p);
  if (var0 & 1) { res->want_proof_ = TlFetchTrue::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
...
void liteServer_getDispatchQueueInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(31878131);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
  if (var0 & 2) { TlStoreBinary::store(after_addr_, s); }
  TlStoreBinary::store(max_accounts_, s);
  if (var0 & 1) { TlStoreTrue::store(want_proof_, s); }
}

void liteServer_getDispatchQueueInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(31878131);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
...
void liteServer_getDispatchQueueInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_getDispatchQueueInfo");
    s.store_field("mode", (var0 = mode_));
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    if (var0 & 2) { s.store_field("after_addr", after_addr_); }
    s.store_field("max_accounts", max_accounts_);
    if (var0 & 1) {  }
    s.store_class_end();
  }
}

liteServer_getDispatchQueueInfo::ReturnType liteServer_getDispatchQueueInfo::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<liteServer_dispatchQueueInfo>, 1561408208>::parse(p);
#undef FAIL
}

liteServer_getDispatchQueueMessages::liteServer_getDispatchQueueMessages()
  : mode_()
  , id_()
  , addr_()
  , after_lt_()
...
liteServer_getDispatchQueueMessages::liteServer_getDispatchQueueMessages(std::int32_t mode_, object_ptr<tonNode_blockIdExt> &&id_, td::Bits256 const &addr_, std::int64_t after_lt_, std::int32_t max_messages_, bool want_proof_, bool one_account_, bool messages_boc_)
  : mode_(mode_)
  , id_(std::move(id_))
  , addr_(addr_)
  , after_lt_(after_lt_)
  , max_messages_(max_messages_)
  , want_proof_(want_proof_)
  , one_account_(one_account_)
  , messages_boc_(messages_boc_)
{}

const std::int32_t liteServer_getDispatchQueueMessages::ID;

object_ptr<liteServer_getDispatchQueueMessages> liteServer_getDispatchQueueMessages::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_getDispatchQueueMessages> res = make_object<liteServer_getDispatchQueueMessages>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
  res->addr_ = TlFetchInt256::parse(p);
  res->after_lt_ = TlFetchLong::parse(p);
  res->max_messages_ = TlFetchInt::parse(p);
  if (var0 & 1) { res->want_proof_ = TlFetchTrue::parse(p); }
  if (var0 & 2) { res->one_account_ = TlFetchTrue::parse(p); }
  if (var0 & 4) { res->messages_boc_ = TlFetchTrue::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void liteServer_getDispatchQueueMessages::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1141021639);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
  TlStoreBinary::store(addr_, s);
  TlStoreBinary::store(after_lt_, s);
  TlStoreBinary::store(max_messages_, s);
  if (var0 & 1) { TlStoreTrue::store(want_proof_, s); }
  if (var0 & 2) { TlStoreTrue::store(one_account_, s); }
  if (var0 & 4) { TlStoreTrue::store(messages_boc_, s); }
}

void liteServer_getDispatchQueueMessages::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1141021639);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
...
void liteServer_getDispatchQueueMessages::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_getDispatchQueueMessages");
    s.store_field("mode", (var0 = mode_));
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_field("addr", addr_);
    s.store_field("after_lt", after_lt_);
    s.store_field("max_messages", max_messages_);
    if (var0 & 1) {  }
    if (var0 & 2) {  }
    if (var0 & 4) {  }
    s.store_class_end();
...
liteServer_getDispatchQueueMessages::ReturnType liteServer_getDispatchQueueMessages::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<liteServer_dispatchQueueMessages>, 1262516529>::parse(p);
#undef FAIL
}
...
liteServer_getLibrariesWithProof::liteServer_getLibrariesWithProof()
  : id_()
  , mode_()
  , library_list_()
{}

liteServer_getLibrariesWithProof::liteServer_getLibrariesWithProof(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t mode_, std::vector<td::Bits256> &&library_list_)
  : id_(std::move(id_))
  , mode_(mode_)
  , library_list_(std::move(library_list_))
{}

const std::int32_t liteServer_getLibrariesWithProof::ID;

object_ptr<liteServer_getLibrariesWithProof> liteServer_getLibrariesWithProof::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_getLibrariesWithProof> res = make_object<liteServer_getLibrariesWithProof>();
  std::int32_t var0;
  res->id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->library_list_ = TlFetchVector<TlFetchInt256>::parse(p);
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void liteServer_getLibrariesWithProof::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-646540355);
  TlStoreObject::store(id_, s);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreVector<TlStoreBinary>::store(library_list_, s);
}

void liteServer_getLibrariesWithProof::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-646540355);
  TlStoreObject::store(id_, s);
  TlStoreBinary::store((var0 = mode_), s);
...
void liteServer_getLibrariesWithProof::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_getLibrariesWithProof");
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_field("mode", (var0 = mode_));
    { const std::vector<td::Bits256> &v = library_list_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("library_list", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { s.store_field("", v[i]); } s.store_class_end(); }
    s.store_class_end();
...
liteServer_getLibrariesWithProof::ReturnType liteServer_getLibrariesWithProof::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<liteServer_libraryResultWithProof>, 279521215>::parse(p);
#undef FAIL
}
...
liteServer_getOutMsgQueueSizes::liteServer_getOutMsgQueueSizes()
  : mode_()
  , wc_()
  , shard_()
{}

liteServer_getOutMsgQueueSizes::liteServer_getOutMsgQueueSizes(std::int32_t mode_, std::int32_t wc_, std::int64_t shard_)
  : mode_(mode_)
  , wc_(wc_)
  , shard_(shard_)
{}

const std::int32_t liteServer_getOutMsgQueueSizes::ID;

object_ptr<liteServer_getOutMsgQueueSizes> liteServer_getOutMsgQueueSizes::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_getOutMsgQueueSizes> res = make_object<liteServer_getOutMsgQueueSizes>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (var0 & 1) { res->wc_ = TlFetchInt::parse(p); }
  if (var0 & 1) { res->shard_ = TlFetchLong::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void liteServer_getOutMsgQueueSizes::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(2076286006);
  TlStoreBinary::store((var0 = mode_), s);
  if (var0 & 1) { TlStoreBinary::store(wc_, s); }
  if (var0 & 1) { TlStoreBinary::store(shard_, s); }
}

void liteServer_getOutMsgQueueSizes::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(2076286006);
  TlStoreBinary::store((var0 = mode_), s);
  if (var0 & 1) { TlStoreBinary::store(wc_, s); }
...
void liteServer_getOutMsgQueueSizes::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_getOutMsgQueueSizes");
    s.store_field("mode", (var0 = mode_));
    if (var0 & 1) { s.store_field("wc", wc_); }
    if (var0 & 1) { s.store_field("shard", shard_); }
    s.store_class_end();
  }
}

liteServer_getOutMsgQueueSizes::ReturnType liteServer_getOutMsgQueueSizes::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<liteServer_outMsgQueueSizes>, -128955901>::parse(p);
#undef FAIL
}
...
liteServer_lookupBlockWithProof::liteServer_lookupBlockWithProof()
  : mode_()
  , id_()
  , mc_block_id_()
  , lt_()
...
liteServer_lookupBlockWithProof::liteServer_lookupBlockWithProof(std::int32_t mode_, object_ptr<tonNode_blockId> &&id_, object_ptr<tonNode_blockIdExt> &&mc_block_id_, std::int64_t lt_, std::int32_t utime_)
  : mode_(mode_)
  , id_(std::move(id_))
  , mc_block_id_(std::move(mc_block_id_))
  , lt_(lt_)
...
const std::int32_t liteServer_lookupBlockWithProof::ID;

object_ptr<liteServer_lookupBlockWithProof> liteServer_lookupBlockWithProof::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_lookupBlockWithProof> res = make_object<liteServer_lookupBlockWithProof>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->id_ = TlFetchObject<tonNode_blockId>::parse(p);
  res->mc_block_id_ = TlFetchObject<tonNode_blockIdExt>::parse(p);
...
void liteServer_lookupBlockWithProof::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1677434888);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
  TlStoreObject::store(mc_block_id_, s);
  if (var0 & 2) { TlStoreBinary::store(lt_, s); }
...
void liteServer_lookupBlockWithProof::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1677434888);
  TlStoreBinary::store((var0 = mode_), s);
  TlStoreObject::store(id_, s);
...
void liteServer_lookupBlockWithProof::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_lookupBlockWithProof");
    s.store_field("mode", (var0 = mode_));
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    if (mc_block_id_ == nullptr) { s.store_field("mc_block_id", "null"); } else { mc_block_id_->store(s, "mc_block_id"); }
    if (var0 & 2) { s.store_field("lt", lt_); }
...
liteServer_lookupBlockWithProof::ReturnType liteServer_lookupBlockWithProof::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<liteServer_lookupBlockResult>, -1720161305>::parse(p);
#undef FAIL
}

liteServer_nonfinal_getCandidate::liteServer_nonfinal_getCandidate()
  : id_()
{}

liteServer_nonfinal_getCandidate::liteServer_nonfinal_getCandidate(object_ptr<liteServer_nonfinal_candidateId> &&id_)
  : id_(std::move(id_))
{}

const std::int32_t liteServer_nonfinal_getCandidate::ID;

object_ptr<liteServer_nonfinal_getCandidate> liteServer_nonfinal_getCandidate::fetch(td::TlParser &p) {
  return make_object<liteServer_nonfinal_getCandidate>(p);
}

liteServer_nonfinal_getCandidate::liteServer_nonfinal_getCandidate(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : id_(TlFetchObject<liteServer_nonfinal_candidateId>::parse(p))
#undef FAIL
{}

void liteServer_nonfinal_getCandidate::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(805803230);
  TlStoreObject::store(id_, s);
}

void liteServer_nonfinal_getCandidate::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(805803230);
  TlStoreObject::store(id_, s);
}

void liteServer_nonfinal_getCandidate::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_nonfinal_getCandidate");
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_class_end();
  }
}

liteServer_nonfinal_getCandidate::ReturnType liteServer_nonfinal_getCandidate::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<liteServer_nonfinal_candidate>, -2134686068>::parse(p);
#undef FAIL
}

liteServer_nonfinal_getValidatorGroups::liteServer_nonfinal_getValidatorGroups()
  : mode_()
  , wc_()
  , shard_()
{}

liteServer_nonfinal_getValidatorGroups::liteServer_nonfinal_getValidatorGroups(std::int32_t mode_, std::int32_t wc_, std::int64_t shard_)
  : mode_(mode_)
  , wc_(wc_)
  , shard_(shard_)
{}

const std::int32_t liteServer_nonfinal_getValidatorGroups::ID;

object_ptr<liteServer_nonfinal_getValidatorGroups> liteServer_nonfinal_getValidatorGroups::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<liteServer_nonfinal_getValidatorGroups> res = make_object<liteServer_nonfinal_getValidatorGroups>();
  std::int32_t var0;
  if ((var0 = res->mode_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (var0 & 1) { res->wc_ = TlFetchInt::parse(p); }
  if (var0 & 1) { res->shard_ = TlFetchLong::parse(p); }
...
void liteServer_nonfinal_getValidatorGroups::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1516694045);
  TlStoreBinary::store((var0 = mode_), s);
  if (var0 & 1) { TlStoreBinary::store(wc_, s); }
  if (var0 & 1) { TlStoreBinary::store(shard_, s); }
}

void liteServer_nonfinal_getValidatorGroups::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1516694045);
  TlStoreBinary::store((var0 = mode_), s);
  if (var0 & 1) { TlStoreBinary::store(wc_, s); }
...
void liteServer_nonfinal_getValidatorGroups::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "liteServer_nonfinal_getValidatorGroups");
    s.store_field("mode", (var0 = mode_));
    if (var0 & 1) { s.store_field("wc", wc_); }
    if (var0 & 1) { s.store_field("shard", shard_); }
    s.store_class_end();
...
liteServer_nonfinal_getValidatorGroups::ReturnType liteServer_nonfinal_getValidatorGroups::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<liteServer_nonfinal_validatorGroups>, -1928618498>::parse(p);
#undef FAIL
}
