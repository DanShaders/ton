...
class tonNode_importedMsgQueueLimits;
...
class adnl_stats_ipPackets;

class adnl_stats_localId;

class adnl_stats_localIdPackets;

class adnl_stats_packets;

class adnl_stats_peerPair;
...
class collatorNode_Candidate;

class collatorNode_error;

class collatorNode_pong;
...
class db_state_persistentStateDescriptionHeader;

class db_state_persistentStateDescriptionShards;

class db_state_persistentStateDescriptionsList;
...
class engine_validator_collationManagerStats;

class engine_validator_collatorNodeWhitelist;

class engine_validator_collatorOptions;

class engine_validator_collatorsList;

class engine_validator_config;

class engine_validator_controlQueryError;

class engine_validator_customOverlay;

class engine_validator_customOverlayNode;

class engine_validator_customOverlaysConfig;
...
class engine_validator_exportedPrivateKeys;

class engine_validator_extraConfig;

class engine_validator_fastSyncMemberCertificate;

class engine_validator_fastSyncOverlayClient;

class engine_validator_fastSyncOverlayStats;
...
class engine_validator_overlayStatsTraffic;
...
class engine_validator_shardOverlayStats;
...
class engine_validator_textStats;

class engine_validator_time;

class engine_validator_collationManagerStats_collator;

class engine_validator_collationManagerStats_localId;

class engine_validator_collationManagerStats_shard;

class engine_validator_collatorsList_collator;

class engine_validator_collatorsList_shard;

class engine_validator_shardOverlayStats_neighbour;
...
class liteserver_descV2;

class liteserver_config_Local;

class liteserver_descV2_shardInfo;

class liteserver_descV2_Slice;
...
class overlay_MemberCertificate;

class overlay_memberCertificateId;

class overlay_Message;

class overlay_messageExtra;

class overlay_node;

class overlay_nodeV2;

class overlay_nodes;

class overlay_nodesV2;
...
class tonNode_fastSyncOverlayId;

class tonNode_forgetPeer;

class tonNode_ihrMessage;

class tonNode_keyBlocks;

class tonNode_newFastSyncMemberCertificate;

class tonNode_newShardBlock;

class tonNode_OutMsgQueueProof;
...
class tonNode_blockBroadcastCompressed_data;

class validator_Group;

class validator_telemetry;
...
class validatorStats_collatedBlock;

class validatorSession_candidate_id;

class validatorStats_blockLimitsStatus;

class validatorStats_collatorNodeResponse;

class validatorStats_endValidatorGroup;

class validatorStats_extMsgsStats;

class validatorStats_newValidatorGroup;

class validatorStats_stats;

class validatorStats_validatedBlock;

class validatorStats_endValidatorGroup_node;

class validatorStats_newValidatorGroup_node;

class validatorStats_stats_producer;

class validatorStats_stats_round;
...
class tonNode_importedMsgQueueLimits final : public Object {
 public:
  std::int32_t max_bytes_;
  std::int32_t max_msgs_;

  tonNode_importedMsgQueueLimits();

  tonNode_importedMsgQueueLimits(std::int32_t max_bytes_, std::int32_t max_msgs_);

  static const std::int32_t ID = -137501941;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<tonNode_importedMsgQueueLimits> fetch(td::TlParser &p);

  explicit tonNode_importedMsgQueueLimits(td::TlParser &p);
...
class adnl_stats final : public Object {
 public:
  double timestamp_;
  std::vector<object_ptr<adnl_stats_localId>> local_ids_;

  adnl_stats();

  adnl_stats(double timestamp_, std::vector<object_ptr<adnl_stats_localId>> &&local_ids_);

  static const std::int32_t ID = 1638879389;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<adnl_stats> fetch(td::TlParser &p);

  explicit adnl_stats(td::TlParser &p);
...
class adnl_stats_ipPackets final : public Object {
 public:
  std::string ip_str_;
  std::int64_t packets_;

  adnl_stats_ipPackets();

  adnl_stats_ipPackets(std::string const &ip_str_, std::int64_t packets_);

  static const std::int32_t ID = -1566159974;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<adnl_stats_ipPackets> fetch(td::TlParser &p);

  explicit adnl_stats_ipPackets(td::TlParser &p);
...
class adnl_stats_localId final : public Object {
 public:
  td::Bits256 short_id_;
  std::vector<object_ptr<adnl_stats_ipPackets>> current_decrypt_;
  object_ptr<adnl_stats_localIdPackets> packets_recent_;
  object_ptr<adnl_stats_localIdPackets> packets_total_;
  std::vector<object_ptr<adnl_stats_peerPair>> peers_;

  adnl_stats_localId();

  adnl_stats_localId(td::Bits256 const &short_id_, std::vector<object_ptr<adnl_stats_ipPackets>> &&current_decrypt_, object_ptr<adnl_stats_localIdPackets> &&packets_recent_, object_ptr<adnl_stats_localIdPackets> &&packets_total_, std::vector<object_ptr<adnl_stats_peerPair>> &&peers_);

  static const std::int32_t ID = 485643774;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<adnl_stats_localId> fetch(td::TlParser &p);

  explicit adnl_stats_localId(td::TlParser &p);
...
class adnl_stats_localIdPackets final : public Object {
 public:
  double ts_start_;
  double ts_end_;
  std::vector<object_ptr<adnl_stats_ipPackets>> decrypted_packets_;
  std::vector<object_ptr<adnl_stats_ipPackets>> dropped_packets_;

  adnl_stats_localIdPackets();

  adnl_stats_localIdPackets(double ts_start_, double ts_end_, std::vector<object_ptr<adnl_stats_ipPackets>> &&decrypted_packets_, std::vector<object_ptr<adnl_stats_ipPackets>> &&dropped_packets_);

  static const std::int32_t ID = -181192842;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<adnl_stats_localIdPackets> fetch(td::TlParser &p);

  explicit adnl_stats_localIdPackets(td::TlParser &p);
...
class adnl_stats_packets final : public Object {
 public:
  double ts_start_;
  double ts_end_;
  std::int64_t in_packets_;
  std::int64_t in_bytes_;
  std::int64_t in_packets_channel_;
  std::int64_t in_bytes_channel_;
  std::int64_t out_packets_;
  std::int64_t out_bytes_;
  std::int64_t out_packets_channel_;
  std::int64_t out_bytes_channel_;
  std::int64_t out_expired_messages_;
  std::int64_t out_expired_bytes_;

  adnl_stats_packets();

  adnl_stats_packets(double ts_start_, double ts_end_, std::int64_t in_packets_, std::int64_t in_bytes_, std::int64_t in_packets_channel_, std::int64_t in_bytes_channel_, std::int64_t out_packets_, std::int64_t out_bytes_, std::int64_t out_packets_channel_, std::int64_t out_bytes_channel_, std::int64_t out_expired_messages_, std::int64_t out_expired_bytes_);

  static const std::int32_t ID = -1660195509;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<adnl_stats_packets> fetch(td::TlParser &p);

  explicit adnl_stats_packets(td::TlParser &p);
...
class adnl_stats_peerPair final : public Object {
 public:
  td::Bits256 local_id_;
  td::Bits256 peer_id_;
  std::string ip_str_;
  object_ptr<adnl_stats_packets> packets_recent_;
  object_ptr<adnl_stats_packets> packets_total_;
  double last_out_packet_ts_;
  double last_in_packet_ts_;
  bool connection_ready_;
  std::int32_t channel_status_;
  double try_reinit_at_;
  std::int64_t out_queue_messages_;
  std::int64_t out_queue_bytes_;

  adnl_stats_peerPair();

  adnl_stats_peerPair(td::Bits256 const &local_id_, td::Bits256 const &peer_id_, std::string const &ip_str_, object_ptr<adnl_stats_packets> &&packets_recent_, object_ptr<adnl_stats_packets> &&packets_total_, double last_out_packet_ts_, double last_in_packet_ts_, bool connection_ready_, std::int32_t channel_status_, double try_reinit_at_, std::int64_t out_queue_messages_, std::int64_t out_queue_bytes_);

  static const std::int32_t ID = -1450386620;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<adnl_stats_peerPair> fetch(td::TlParser &p);

  explicit adnl_stats_peerPair(td::TlParser &p);
...
class collatorNode_Candidate: public Object {
 public:

  static object_ptr<collatorNode_Candidate> fetch(td::TlParser &p);
};

class collatorNode_candidate final : public collatorNode_Candidate {
 public:
  ...
  collatorNode_candidate();

  collatorNode_candidate(object_ptr<PublicKey> &&source_, object_ptr<tonNode_blockIdExt> &&id_, td::BufferSlice &&data_, td::BufferSlice &&collated_data_);

  static const std::int32_t ID = 540932103;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit collatorNode_candidate(td::TlParser &p);
...
class collatorNode_compressedCandidate final : public collatorNode_Candidate {
 public:
  std::int32_t flags_;
  object_ptr<PublicKey> source_;
  object_ptr<tonNode_blockIdExt> id_;
  std::int32_t decompressed_size_;
  td::BufferSlice data_;

  collatorNode_compressedCandidate();

  collatorNode_compressedCandidate(std::int32_t flags_, object_ptr<PublicKey> &&source_, object_ptr<tonNode_blockIdExt> &&id_, std::int32_t decompressed_size_, td::BufferSlice &&data_);

  static const std::int32_t ID = -1174932661;
  std::int32_t get_id() const final {
    return ID;
  }
...
class collatorNode_error final : public Object {
 public:
  std::int32_t code_;
  std::string message_;
  ...
  collatorNode_error(std::int32_t code_, std::string const &message_);

  static const std::int32_t ID = -1896906830;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<collatorNode_error> fetch(td::TlParser &p);

  explicit collatorNode_error(td::TlParser &p);
...
class collatorNode_pong final : public Object {
 public:
  std::int32_t flags_;

  collatorNode_pong();

  explicit collatorNode_pong(std::int32_t flags_);

  static const std::int32_t ID = 1539245345;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<collatorNode_pong> fetch(td::TlParser &p);
...
class db_filedb_key_candidateRef final : public db_filedb_Key {
 public:
  object_ptr<tonNode_blockIdExt> id_;

  db_filedb_key_candidateRef();

  explicit db_filedb_key_candidateRef(object_ptr<tonNode_blockIdExt> &&id_);

  static const std::int32_t ID = -431144258;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit db_filedb_key_candidateRef(td::TlParser &p);
...
class db_state_key_persistentStateDescriptionShards final : public db_state_Key {
 public:
  std::int32_t masterchain_seqno_;

  db_state_key_persistentStateDescriptionShards();

  explicit db_state_key_persistentStateDescriptionShards(std::int32_t masterchain_seqno_);

  static const std::int32_t ID = -1852061816;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit db_state_key_persistentStateDescriptionShards(td::TlParser &p);
...
class db_state_key_persistentStateDescriptionsList final : public db_state_Key {
 public:

  db_state_key_persistentStateDescriptionsList();

  static const std::int32_t ID = 1511487946;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit db_state_key_persistentStateDescriptionsList(td::TlParser &p);
...
class db_state_persistentStateDescriptionHeader final : public Object {
 public:
  ...
  db_state_persistentStateDescriptionHeader(object_ptr<tonNode_blockIdExt> &&masterchain_id_, std::int32_t start_time_, std::int32_t end_time_);

  static const std::int32_t ID = -1325128876;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<db_state_persistentStateDescriptionHeader> fetch(td::TlParser &p);

  explicit db_state_persistentStateDescriptionHeader(td::TlParser &p);
...
class db_state_persistentStateDescriptionShards final : public Object {
 public:
  std::vector<object_ptr<tonNode_blockIdExt>> shard_blocks_;

  db_state_persistentStateDescriptionShards();

  explicit db_state_persistentStateDescriptionShards(std::vector<object_ptr<tonNode_blockIdExt>> &&shard_blocks_);

  static const std::int32_t ID = -433023920;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<db_state_persistentStateDescriptionShards> fetch(td::TlParser &p);

  explicit db_state_persistentStateDescriptionShards(td::TlParser &p);
...
class db_state_persistentStateDescriptionsList final : public Object {
 public:
  std::vector<object_ptr<db_state_persistentStateDescriptionHeader>> list_;

  db_state_persistentStateDescriptionsList();

  explicit db_state_persistentStateDescriptionsList(std::vector<object_ptr<db_state_persistentStateDescriptionHeader>> &&list_);

  static const std::int32_t ID = -1485326599;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<db_state_persistentStateDescriptionsList> fetch(td::TlParser &p);

  explicit db_state_persistentStateDescriptionsList(td::TlParser &p);
...
class engine_collator final : public Object {
 public:
  td::Bits256 adnl_id_;
  object_ptr<tonNode_shardId> shard_;

  engine_collator();

  engine_collator(td::Bits256 const &adnl_id_, object_ptr<tonNode_shardId> &&shard_);

  static const std::int32_t ID = -297975208;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_collator> fetch(td::TlParser &p);

  explicit engine_collator(td::TlParser &p);
...
class engine_validator_collationManagerStats final : public Object {
 public:
  std::vector<object_ptr<engine_validator_collationManagerStats_localId>> local_ids_;

  engine_validator_collationManagerStats();

  explicit engine_validator_collationManagerStats(std::vector<object_ptr<engine_validator_collationManagerStats_localId>> &&local_ids_);

  static const std::int32_t ID = 402697037;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_collationManagerStats> fetch(td::TlParser &p);

  explicit engine_validator_collationManagerStats(td::TlParser &p);
...
class engine_validator_collatorNodeWhitelist final : public Object {
 public:
  bool enabled_;
  std::vector<td::Bits256> adnl_ids_;

  engine_validator_collatorNodeWhitelist();

  engine_validator_collatorNodeWhitelist(bool enabled_, std::vector<td::Bits256> &&adnl_ids_);

  static const std::int32_t ID = -484118479;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_collatorNodeWhitelist> fetch(td::TlParser &p);

  explicit engine_validator_collatorNodeWhitelist(td::TlParser &p);
...
class engine_validator_collatorOptions final : public Object {
 public:
  bool deferring_enabled_;
  std::int32_t defer_messages_after_;
  std::int64_t defer_out_queue_size_limit_;
  std::int32_t dispatch_phase_2_max_total_;
  std::int32_t dispatch_phase_3_max_total_;
  std::int32_t dispatch_phase_2_max_per_initiator_;
  std::int32_t dispatch_phase_3_max_per_initiator_;
  std::vector<std::string> whitelist_;
  std::vector<std::string> prioritylist_;
  bool force_full_collated_data_;
  bool ignore_collated_data_limits_;

  engine_validator_collatorOptions();

  engine_validator_collatorOptions(bool deferring_enabled_, std::int32_t defer_messages_after_, std::int64_t defer_out_queue_size_limit_, std::int32_t dispatch_phase_2_max_total_, std::int32_t dispatch_phase_3_max_total_, std::int32_t dispatch_phase_2_max_per_initiator_, std::int32_t dispatch_phase_3_max_per_initiator_, std::vector<std::string> &&whitelist_, std::vector<std::string> &&prioritylist_, bool force_full_collated_data_, bool ignore_collated_data_limits_);

  static const std::int32_t ID = 71182465;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_collatorOptions> fetch(td::TlParser &p);

  explicit engine_validator_collatorOptions(td::TlParser &p);
...
class engine_validator_collatorsList final : public Object {
 public:
  std::vector<object_ptr<engine_validator_collatorsList_shard>> shards_;

  engine_validator_collatorsList();

  explicit engine_validator_collatorsList(std::vector<object_ptr<engine_validator_collatorsList_shard>> &&shards_);

  static const std::int32_t ID = -350754052;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_collatorsList> fetch(td::TlParser &p);

  explicit engine_validator_collatorsList(td::TlParser &p);
...
class engine_validator_config final : public Object {
 public:
  ...
  std::vector<object_ptr<engine_collator>> collators_;
  ...
  object_ptr<engine_validator_extraConfig> extraconfig_;
  std::vector<object_ptr<engine_liteServer>> liteservers_;
  std::vector<object_ptr<engine_controlInterface>> control_;
  std::vector<object_ptr<tonNode_shardId>> shards_to_monitor_;
  object_ptr<engine_gc> gc_;

  engine_validator_config();

  engine_validator_config(std::int32_t out_port_, std::vector<object_ptr<engine_Addr>> &&addrs_, std::vector<object_ptr<engine_adnl>> &&adnl_, std::vector<object_ptr<engine_dht>> &&dht_, std::vector<object_ptr<engine_validator>> &&validators_, std::vector<object_ptr<engine_collator>> &&collators_, td::Bits256 const &fullnode_, std::vector<object_ptr<engine_validator_fullNodeSlave>> &&fullnodeslaves_, std::vector<object_ptr<engine_validator_fullNodeMaster>> &&fullnodemasters_, object_ptr<engine_validator_fullNodeConfig> &&fullnodeconfig_, object_ptr<engine_validator_extraConfig> &&extraconfig_, std::vector<object_ptr<engine_liteServer>> &&liteservers_, std::vector<object_ptr<engine_controlInterface>> &&control_, std::vector<object_ptr<tonNode_shardId>> &&shards_to_monitor_, object_ptr<engine_gc> &&gc_);

  static const std::int32_t ID = -1647573204;
  std::int32_t get_id() const final {
    return ID;
  }
...
class engine_validator_customOverlay final : public Object {
 public:
  std::string name_;
  std::vector<object_ptr<engine_validator_customOverlayNode>> nodes_;
  std::vector<object_ptr<tonNode_shardId>> sender_shards_;

  engine_validator_customOverlay();

  engine_validator_customOverlay(std::string const &name_, std::vector<object_ptr<engine_validator_customOverlayNode>> &&nodes_, std::vector<object_ptr<tonNode_shardId>> &&sender_shards_);

  static const std::int32_t ID = -1536918323;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_customOverlay> fetch(td::TlParser &p);

  explicit engine_validator_customOverlay(td::TlParser &p);
...
class engine_validator_customOverlayNode final : public Object {
 public:
  td::Bits256 adnl_id_;
  bool msg_sender_;
  std::int32_t msg_sender_priority_;
  bool block_sender_;

  engine_validator_customOverlayNode();

  engine_validator_customOverlayNode(td::Bits256 const &adnl_id_, bool msg_sender_, std::int32_t msg_sender_priority_, bool block_sender_);

  static const std::int32_t ID = 692575999;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_customOverlayNode> fetch(td::TlParser &p);

  explicit engine_validator_customOverlayNode(td::TlParser &p);
...
class engine_validator_customOverlaysConfig final : public Object {
 public:
  std::vector<object_ptr<engine_validator_customOverlay>> overlays_;

  engine_validator_customOverlaysConfig();

  explicit engine_validator_customOverlaysConfig(std::vector<object_ptr<engine_validator_customOverlay>> &&overlays_);

  static const std::int32_t ID = 1081752345;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_customOverlaysConfig> fetch(td::TlParser &p);

  explicit engine_validator_customOverlaysConfig(td::TlParser &p);
...
class engine_validator_exportedPrivateKeys final : public Object {
 public:
  td::BufferSlice encrypted_data_;

  engine_validator_exportedPrivateKeys();

  explicit engine_validator_exportedPrivateKeys(td::BufferSlice &&encrypted_data_);

  static const std::int32_t ID = -1189054063;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_exportedPrivateKeys> fetch(td::TlParser &p);

  explicit engine_validator_exportedPrivateKeys(td::TlParser &p);
...
class engine_validator_extraConfig final : public Object {
 public:
  bool state_serializer_enabled_;
  std::vector<object_ptr<engine_validator_fastSyncMemberCertificate>> fast_sync_member_certificates_;
  object_ptr<engine_validator_collatorNodeWhitelist> collator_node_whitelist_;
  std::vector<object_ptr<engine_validator_fastSyncOverlayClient>> fast_sync_overlay_clients_;

  engine_validator_extraConfig();

  engine_validator_extraConfig(bool state_serializer_enabled_, std::vector<object_ptr<engine_validator_fastSyncMemberCertificate>> &&fast_sync_member_certificates_, object_ptr<engine_validator_collatorNodeWhitelist> &&collator_node_whitelist_, std::vector<object_ptr<engine_validator_fastSyncOverlayClient>> &&fast_sync_overlay_clients_);

  static const std::int32_t ID = 847549418;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_extraConfig> fetch(td::TlParser &p);

  explicit engine_validator_extraConfig(td::TlParser &p);
...
class engine_validator_fastSyncMemberCertificate final : public Object {
 public:
  td::Bits256 adnl_id_;
  object_ptr<overlay_MemberCertificate> certificate_;

  engine_validator_fastSyncMemberCertificate();

  engine_validator_fastSyncMemberCertificate(td::Bits256 const &adnl_id_, object_ptr<overlay_MemberCertificate> &&certificate_);

  static const std::int32_t ID = -722821601;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_fastSyncMemberCertificate> fetch(td::TlParser &p);

  explicit engine_validator_fastSyncMemberCertificate(td::TlParser &p);
...
class engine_validator_fastSyncOverlayClient final : public Object {
 public:
  td::Bits256 adnl_id_;
  std::int32_t slot_;

  engine_validator_fastSyncOverlayClient();

  engine_validator_fastSyncOverlayClient(td::Bits256 const &adnl_id_, std::int32_t slot_);

  static const std::int32_t ID = 1395058805;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_fastSyncOverlayClient> fetch(td::TlParser &p);

  explicit engine_validator_fastSyncOverlayClient(td::TlParser &p);
...
class engine_validator_fastSyncOverlayStats final : public Object {
 public:
  std::string shard_;
  std::vector<td::Bits256> validators_adnl_;
  std::vector<td::Bits256> root_public_keys_;
  object_ptr<overlay_MemberCertificate> member_certificate_;

  engine_validator_fastSyncOverlayStats();

  engine_validator_fastSyncOverlayStats(std::string const &shard_, std::vector<td::Bits256> &&validators_adnl_, std::vector<td::Bits256> &&root_public_keys_, object_ptr<overlay_MemberCertificate> &&member_certificate_);

  static const std::int32_t ID = -14698336;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_fastSyncOverlayStats> fetch(td::TlParser &p);

  explicit engine_validator_fastSyncOverlayStats(td::TlParser &p);
...
class engine_validator_overlayStats final : public Object {
 public:
  ...
  object_ptr<engine_validator_overlayStatsTraffic> total_traffic_;
  object_ptr<engine_validator_overlayStatsTraffic> total_traffic_responses_;
  std::string extra_;

  engine_validator_overlayStats();

  engine_validator_overlayStats(td::Bits256 const &overlay_id_, object_ptr<PublicKey> &&overlay_id_full_, td::Bits256 const &adnl_id_, std::string const &scope_, std::vector<object_ptr<engine_validator_overlayStatsNode>> &&nodes_, std::vector<object_ptr<engine_validator_oneStat>> &&stats_, object_ptr<engine_validator_overlayStatsTraffic> &&total_traffic_, object_ptr<engine_validator_overlayStatsTraffic> &&total_traffic_responses_, std::string const &extra_);

  static const std::int32_t ID = 1874130251;
  std::int32_t get_id() const final {
    return ID;
  }
...
class engine_validator_overlayStatsNode final : public Object {
 public:
  ...
  bool is_neighbour_;
  bool is_alive_;
  std::int32_t node_flags_;
  std::int32_t bdcst_errors_;
  std::int32_t fec_bdcst_errors_;
  std::int32_t last_in_query_;
  std::int32_t last_out_query_;
  object_ptr<engine_validator_overlayStatsTraffic> traffic_;
  object_ptr<engine_validator_overlayStatsTraffic> traffic_responses_;

  engine_validator_overlayStatsNode();

  engine_validator_overlayStatsNode(td::Bits256 const &adnl_id_, std::string const &ip_addr_, bool is_neighbour_, bool is_alive_, std::int32_t node_flags_, std::int32_t bdcst_errors_, std::int32_t fec_bdcst_errors_, std::int32_t last_in_query_, std::int32_t last_out_query_, object_ptr<engine_validator_overlayStatsTraffic> &&traffic_, object_ptr<engine_validator_overlayStatsTraffic> &&traffic_responses_);

  static const std::int32_t ID = -775469870;
  std::int32_t get_id() const final {
    return ID;
  }
...
class engine_validator_overlayStatsTraffic final : public Object {
 public:
  std::int64_t t_out_bytes_;
  std::int64_t t_in_bytes_;
  std::int32_t t_out_pckts_;
  std::int32_t t_in_pckts_;

  engine_validator_overlayStatsTraffic();

  engine_validator_overlayStatsTraffic(std::int64_t t_out_bytes_, std::int64_t t_in_bytes_, std::int32_t t_out_pckts_, std::int32_t t_in_pckts_);

  static const std::int32_t ID = 1494746854;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_overlayStatsTraffic> fetch(td::TlParser &p);

  explicit engine_validator_overlayStatsTraffic(td::TlParser &p);
...
class engine_validator_shardOutQueueSize final : public Object {
 public:
  ...
  explicit engine_validator_shardOutQueueSize(std::int64_t size_);

  static const std::int32_t ID = 2098409467;
  std::int32_t get_id() const final {
    return ID;
  }
...
class engine_validator_shardOverlayStats final : public Object {
 public:
  std::string shard_;
  bool active_;
  std::vector<object_ptr<engine_validator_shardOverlayStats_neighbour>> neighbours_;

  engine_validator_shardOverlayStats();

  engine_validator_shardOverlayStats(std::string const &shard_, bool active_, std::vector<object_ptr<engine_validator_shardOverlayStats_neighbour>> &&neighbours_);

  static const std::int32_t ID = 1131748080;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_shardOverlayStats> fetch(td::TlParser &p);

  explicit engine_validator_shardOverlayStats(td::TlParser &p);
...
class engine_validator_textStats final : public Object {
 public:
  std::string data_;

  engine_validator_textStats();

  explicit engine_validator_textStats(std::string const &data_);

  static const std::int32_t ID = -1176803271;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_textStats> fetch(td::TlParser &p);

  explicit engine_validator_textStats(td::TlParser &p);
...
class engine_validator_collationManagerStats_collator final : public Object {
 public:
  td::Bits256 adnl_id_;
  bool active_;
  bool alive_;
  double ping_in_;
  double last_ping_ago_;
  std::string last_ping_status_;

  engine_validator_collationManagerStats_collator();

  engine_validator_collationManagerStats_collator(td::Bits256 const &adnl_id_, bool active_, bool alive_, double ping_in_, double last_ping_ago_, std::string const &last_ping_status_);

  static const std::int32_t ID = 388106561;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_collationManagerStats_collator> fetch(td::TlParser &p);

  explicit engine_validator_collationManagerStats_collator(td::TlParser &p);
...
class engine_validator_collationManagerStats_localId final : public Object {
 public:
  td::Bits256 adnl_id_;
  std::vector<object_ptr<engine_validator_collationManagerStats_shard>> shards_;
  std::vector<object_ptr<engine_validator_collationManagerStats_collator>> collators_;

  engine_validator_collationManagerStats_localId();

  engine_validator_collationManagerStats_localId(td::Bits256 const &adnl_id_, std::vector<object_ptr<engine_validator_collationManagerStats_shard>> &&shards_, std::vector<object_ptr<engine_validator_collationManagerStats_collator>> &&collators_);

  static const std::int32_t ID = -1807470882;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_collationManagerStats_localId> fetch(td::TlParser &p);

  explicit engine_validator_collationManagerStats_localId(td::TlParser &p);
...
class engine_validator_collationManagerStats_shard final : public Object {
 public:
  object_ptr<tonNode_shardId> shard_id_;
  bool self_collate_;
  std::string select_mode_;
  bool active_;
  std::vector<td::Bits256> collators_;

  engine_validator_collationManagerStats_shard();

  engine_validator_collationManagerStats_shard(object_ptr<tonNode_shardId> &&shard_id_, bool self_collate_, std::string const &select_mode_, bool active_, std::vector<td::Bits256> &&collators_);

  static const std::int32_t ID = -123361695;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_collationManagerStats_shard> fetch(td::TlParser &p);

  explicit engine_validator_collationManagerStats_shard(td::TlParser &p);
...
class engine_validator_collatorsList_collator final : public Object {
 public:
  td::Bits256 adnl_id_;

  engine_validator_collatorsList_collator();

  explicit engine_validator_collatorsList_collator(td::Bits256 const &adnl_id_);

  static const std::int32_t ID = -786459762;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_collatorsList_collator> fetch(td::TlParser &p);

  explicit engine_validator_collatorsList_collator(td::TlParser &p);
...
class engine_validator_collatorsList_shard final : public Object {
 public:
  object_ptr<tonNode_shardId> shard_id_;
  std::vector<object_ptr<engine_validator_collatorsList_collator>> collators_;
  bool self_collate_;
  std::string select_mode_;

  engine_validator_collatorsList_shard();

  engine_validator_collatorsList_shard(object_ptr<tonNode_shardId> &&shard_id_, std::vector<object_ptr<engine_validator_collatorsList_collator>> &&collators_, bool self_collate_, std::string const &select_mode_);

  static const std::int32_t ID = 1380958561;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_collatorsList_shard> fetch(td::TlParser &p);

  explicit engine_validator_collatorsList_shard(td::TlParser &p);
...
class engine_validator_shardOverlayStats_neighbour final : public Object {
 public:
  std::string id_;
  std::int32_t verison_major_;
  std::int32_t version_minor_;
  std::int32_t flags_;
  double roundtrip_;
  double unreliability_;

  engine_validator_shardOverlayStats_neighbour();

  engine_validator_shardOverlayStats_neighbour(std::string const &id_, std::int32_t verison_major_, std::int32_t version_minor_, std::int32_t flags_, double roundtrip_, double unreliability_);

  static const std::int32_t ID = -1723992174;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_shardOverlayStats_neighbour> fetch(td::TlParser &p);
...
class liteclient_config_global final : public Object {
 public:
  ...
  std::vector<object_ptr<liteserver_descV2>> liteservers_v2_;
  object_ptr<validator_config_global> validator_;

  liteclient_config_global();

  liteclient_config_global(std::vector<object_ptr<liteserver_desc>> &&liteservers_, std::vector<object_ptr<liteserver_descV2>> &&liteservers_v2_, object_ptr<validator_config_global> &&validator_);

  static const std::int32_t ID = -393642067;
  std::int32_t get_id() const final {
    return ID;
  }
...
class liteserver_descV2 final : public Object {
 public:
  object_ptr<PublicKey> id_;
  std::int32_t ip_;
  std::int32_t port_;
  std::vector<object_ptr<liteserver_descV2_Slice>> slices_;

  liteserver_descV2();

  liteserver_descV2(object_ptr<PublicKey> &&id_, std::int32_t ip_, std::int32_t port_, std::vector<object_ptr<liteserver_descV2_Slice>> &&slices_);

  static const std::int32_t ID = 1259281547;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteserver_descV2> fetch(td::TlParser &p);

  explicit liteserver_descV2(td::TlParser &p);
...
class liteserver_descV2_shardInfo final : public Object {
 public:
  object_ptr<tonNode_shardId> shard_id_;
  std::int32_t seqno_;
  std::int32_t utime_;
  ...
  liteserver_descV2_shardInfo();

  liteserver_descV2_shardInfo(object_ptr<tonNode_shardId> &&shard_id_, std::int32_t seqno_, std::int32_t utime_, std::int64_t lt_);

  static const std::int32_t ID = 36288420;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<liteserver_descV2_shardInfo> fetch(td::TlParser &p);

  explicit liteserver_descV2_shardInfo(td::TlParser &p);
...
class liteserver_descV2_Slice: public Object {
 public:

  static object_ptr<liteserver_descV2_Slice> fetch(td::TlParser &p);
};

class liteserver_descV2_sliceSimple final : public liteserver_descV2_Slice {
 public:
  std::vector<object_ptr<tonNode_shardId>> shards_;

  liteserver_descV2_sliceSimple();

  explicit liteserver_descV2_sliceSimple(std::vector<object_ptr<tonNode_shardId>> &&shards_);

  static const std::int32_t ID = -2000071413;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit liteserver_descV2_sliceSimple(td::TlParser &p);
...
class liteserver_descV2_sliceTimed final : public liteserver_descV2_Slice {
 public:
  std::vector<object_ptr<liteserver_descV2_shardInfo>> shards_from_;
  std::vector<object_ptr<liteserver_descV2_shardInfo>> shards_to_;

  liteserver_descV2_sliceTimed();

  liteserver_descV2_sliceTimed(std::vector<object_ptr<liteserver_descV2_shardInfo>> &&shards_from_, std::vector<object_ptr<liteserver_descV2_shardInfo>> &&shards_to_);

  static const std::int32_t ID = -1018221070;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit liteserver_descV2_sliceTimed(td::TlParser &p);
...
class overlay_MemberCertificate: public Object {
 public:

  static object_ptr<overlay_MemberCertificate> fetch(td::TlParser &p);
};

class overlay_memberCertificate final : public overlay_MemberCertificate {
 public:
  object_ptr<PublicKey> issued_by_;
  std::int32_t flags_;
  std::int32_t slot_;
  ...
  overlay_memberCertificate();

  overlay_memberCertificate(object_ptr<PublicKey> &&issued_by_, std::int32_t flags_, std::int32_t slot_, std::int32_t expire_at_, td::BufferSlice &&signature_);

  static const std::int32_t ID = -1040151463;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit overlay_memberCertificate(td::TlParser &p);
...
class overlay_emptyMemberCertificate final : public overlay_MemberCertificate {
 public:

  overlay_emptyMemberCertificate();

  static const std::int32_t ID = -1071365662;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit overlay_emptyMemberCertificate(td::TlParser &p);
...
class overlay_memberCertificateId final : public Object {
 public:
  object_ptr<adnl_id_short> node_;
  std::int32_t flags_;
  std::int32_t slot_;
  std::int32_t expire_at_;

  overlay_memberCertificateId();

  overlay_memberCertificateId(object_ptr<adnl_id_short> &&node_, std::int32_t flags_, std::int32_t slot_, std::int32_t expire_at_);

  static const std::int32_t ID = 747101234;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<overlay_memberCertificateId> fetch(td::TlParser &p);

  explicit overlay_memberCertificateId(td::TlParser &p);
...
class overlay_Message: public Object {
 public:

  static object_ptr<overlay_Message> fetch(td::TlParser &p);
};

class overlay_message final : public overlay_Message {
 public:
  td::Bits256 overlay_;
...
class overlay_messageWithExtra final : public overlay_Message {
 public:
  td::Bits256 overlay_;
  object_ptr<overlay_messageExtra> extra_;

  overlay_messageWithExtra();

  overlay_messageWithExtra(td::Bits256 const &overlay_, object_ptr<overlay_messageExtra> &&extra_);

  static const std::int32_t ID = -1573772483;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit overlay_messageWithExtra(td::TlParser &p);
...
class overlay_messageExtra final : public Object {
 public:
  std::int32_t flags_;
  object_ptr<overlay_MemberCertificate> certificate_;
  enum Flags : std::int32_t {CERTIFICATE_MASK = 1};

  overlay_messageExtra();

  overlay_messageExtra(std::int32_t flags_, object_ptr<overlay_MemberCertificate> &&certificate_);

  static const std::int32_t ID = 785967269;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<overlay_messageExtra> fetch(td::TlParser &p);
...
class overlay_nodeV2 final : public Object {
 public:
  object_ptr<PublicKey> id_;
  td::Bits256 overlay_;
  std::int32_t flags_;
  ...
  overlay_nodeV2(object_ptr<PublicKey> &&id_, td::Bits256 const &overlay_, std::int32_t flags_, std::int32_t version_, td::BufferSlice &&signature_, object_ptr<overlay_MemberCertificate> &&certificate_);

  static const std::int32_t ID = -1113870937;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<overlay_nodeV2> fetch(td::TlParser &p);

  explicit overlay_nodeV2(td::TlParser &p);
...
class overlay_nodesV2 final : public Object {
 public:
  std::vector<object_ptr<overlay_nodeV2>> nodes_;

  overlay_nodesV2();

  explicit overlay_nodesV2(std::vector<object_ptr<overlay_nodeV2>> &&nodes_);

  static const std::int32_t ID = 449963576;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<overlay_nodesV2> fetch(td::TlParser &p);

  explicit overlay_nodesV2(td::TlParser &p);
...
class overlay_db_Nodes: public Object {
 public:

  static object_ptr<overlay_db_Nodes> fetch(td::TlParser &p);
};

class overlay_db_nodesV2 final : public overlay_db_Nodes {
 public:
  object_ptr<overlay_nodesV2> nodes_;

  overlay_db_nodesV2();

  explicit overlay_db_nodesV2(object_ptr<overlay_nodesV2> &&nodes_);

  static const std::int32_t ID = 917053760;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit overlay_db_nodesV2(td::TlParser &p);
...
class overlay_db_nodes final : public overlay_db_Nodes {
 public:
...
class overlay_node_ToSign: public Object {
 public:

  static object_ptr<overlay_node_ToSign> fetch(td::TlParser &p);
};

class overlay_node_toSign final : public overlay_node_ToSign {
 public:
  object_ptr<adnl_id_short> id_;
  td::Bits256 overlay_;
  std::int32_t version_;
...
class overlay_node_toSignEx final : public overlay_node_ToSign {
 public:
  object_ptr<adnl_id_short> id_;
  td::Bits256 overlay_;
  std::int32_t flags_;
  ...
  overlay_node_toSignEx();

  overlay_node_toSignEx(object_ptr<adnl_id_short> &&id_, td::Bits256 const &overlay_, std::int32_t flags_, std::int32_t version_);

  static const std::int32_t ID = -2072352791;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit overlay_node_toSignEx(td::TlParser &p);
...
class proxyLiteserver_config final : public Object {
 public:
  std::int32_t port_;
  object_ptr<PublicKey> id_;

  proxyLiteserver_config();

  proxyLiteserver_config(std::int32_t port_, object_ptr<PublicKey> &&id_);

  static const std::int32_t ID = 808543630;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<proxyLiteserver_config> fetch(td::TlParser &p);

  explicit proxyLiteserver_config(td::TlParser &p);
...
class tonNode_blockBroadcastCompressed final : public tonNode_Broadcast {
 public:
  object_ptr<tonNode_blockIdExt> id_;
  std::int32_t catchain_seqno_;
  std::int32_t validator_set_hash_;
  std::int32_t flags_;
  td::BufferSlice compressed_;

  tonNode_blockBroadcastCompressed();

  tonNode_blockBroadcastCompressed(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t catchain_seqno_, std::int32_t validator_set_hash_, std::int32_t flags_, td::BufferSlice &&compressed_);

  static const std::int32_t ID = 167581507;
  std::int32_t get_id() const final {
    return ID;
  }
...
class tonNode_newBlockCandidateBroadcast final : public tonNode_Broadcast {
 public:
  object_ptr<tonNode_blockIdExt> id_;
  std::int32_t catchain_seqno_;
  std::int32_t validator_set_hash_;
  object_ptr<tonNode_blockSignature> collator_signature_;
  td::BufferSlice data_;

  tonNode_newBlockCandidateBroadcast();

  tonNode_newBlockCandidateBroadcast(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t catchain_seqno_, std::int32_t validator_set_hash_, object_ptr<tonNode_blockSignature> &&collator_signature_, td::BufferSlice &&data_);

  static const std::int32_t ID = -1074983488;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit tonNode_newBlockCandidateBroadcast(td::TlParser &p);
...
class tonNode_newBlockCandidateBroadcastCompressed final : public tonNode_Broadcast {
 public:
  object_ptr<tonNode_blockIdExt> id_;
  std::int32_t catchain_seqno_;
  std::int32_t validator_set_hash_;
  ...
  tonNode_newBlockCandidateBroadcastCompressed();

  tonNode_newBlockCandidateBroadcastCompressed(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t catchain_seqno_, std::int32_t validator_set_hash_, object_ptr<tonNode_blockSignature> &&collator_signature_, std::int32_t flags_, td::BufferSlice &&compressed_);

  static const std::int32_t ID = 215509140;
  std::int32_t get_id() const final {
    return ID;
  }
...
class tonNode_outMsgQueueProofBroadcast final : public tonNode_Broadcast {
 public:
  object_ptr<tonNode_shardId> dst_shard_;
  object_ptr<tonNode_blockIdExt> block_;
  object_ptr<tonNode_importedMsgQueueLimits> limits_;
  object_ptr<tonNode_OutMsgQueueProof> proof_;

  tonNode_outMsgQueueProofBroadcast();

  tonNode_outMsgQueueProofBroadcast(object_ptr<tonNode_shardId> &&dst_shard_, object_ptr<tonNode_blockIdExt> &&block_, object_ptr<tonNode_importedMsgQueueLimits> &&limits_, object_ptr<tonNode_OutMsgQueueProof> &&proof_);

  static const std::int32_t ID = 912191409;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit tonNode_outMsgQueueProofBroadcast(td::TlParser &p);
...
class tonNode_capabilities final : public Object {
 public:
  ...
  tonNode_capabilities(std::int32_t version_major_, std::int32_t version_minor_, std::int32_t flags_);
...
class tonNode_customOverlayId final : public Object {
 public:
  td::Bits256 zero_state_file_hash_;
  std::string name_;
  std::vector<td::Bits256> nodes_;

  tonNode_customOverlayId();

  tonNode_customOverlayId(td::Bits256 const &zero_state_file_hash_, std::string const &name_, std::vector<td::Bits256> &&nodes_);

  static const std::int32_t ID = 968105638;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<tonNode_customOverlayId> fetch(td::TlParser &p);

  explicit tonNode_customOverlayId(td::TlParser &p);
...
class tonNode_dataFullCompressed final : public tonNode_DataFull {
 public:
  object_ptr<tonNode_blockIdExt> id_;
  std::int32_t flags_;
  td::BufferSlice compressed_;
  ...
  tonNode_dataFullCompressed();

  tonNode_dataFullCompressed(object_ptr<tonNode_blockIdExt> &&id_, std::int32_t flags_, td::BufferSlice &&compressed_, bool is_link_);

  static const std::int32_t ID = 1178414245;
  std::int32_t get_id() const final {
    return ID;
  }
...
class tonNode_fastSyncOverlayId final : public Object {
 public:
  td::Bits256 zero_state_file_hash_;
  object_ptr<tonNode_shardId> shard_;

  tonNode_fastSyncOverlayId();

  tonNode_fastSyncOverlayId(td::Bits256 const &zero_state_file_hash_, object_ptr<tonNode_shardId> &&shard_);

  static const std::int32_t ID = 452003156;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<tonNode_fastSyncOverlayId> fetch(td::TlParser &p);

  explicit tonNode_fastSyncOverlayId(td::TlParser &p);
...
class tonNode_forgetPeer final : public Object {
 public:

  tonNode_forgetPeer();

  static const std::int32_t ID = -1423772543;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<tonNode_forgetPeer> fetch(td::TlParser &p);

  explicit tonNode_forgetPeer(td::TlParser &p);
...
class tonNode_newFastSyncMemberCertificate final : public Object {
 public:
  td::Bits256 adnl_id_;
  object_ptr<overlay_MemberCertificate> certificate_;

  tonNode_newFastSyncMemberCertificate();

  tonNode_newFastSyncMemberCertificate(td::Bits256 const &adnl_id_, object_ptr<overlay_MemberCertificate> &&certificate_);

  static const std::int32_t ID = 1939862959;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<tonNode_newFastSyncMemberCertificate> fetch(td::TlParser &p);

  explicit tonNode_newFastSyncMemberCertificate(td::TlParser &p);
...
class tonNode_OutMsgQueueProof: public Object {
 public:

  static object_ptr<tonNode_OutMsgQueueProof> fetch(td::TlParser &p);
};

class tonNode_outMsgQueueProof final : public tonNode_OutMsgQueueProof {
 public:
  td::BufferSlice queue_proofs_;
  td::BufferSlice block_state_proofs_;
  std::vector<std::int32_t> msg_counts_;

  tonNode_outMsgQueueProof();

  tonNode_outMsgQueueProof(td::BufferSlice &&queue_proofs_, td::BufferSlice &&block_state_proofs_, std::vector<std::int32_t> &&msg_counts_);

  static const std::int32_t ID = 1543642066;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit tonNode_outMsgQueueProof(td::TlParser &p);
...
class tonNode_outMsgQueueProofEmpty final : public tonNode_OutMsgQueueProof {
 public:

  tonNode_outMsgQueueProofEmpty();

  static const std::int32_t ID = -1600516382;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit tonNode_outMsgQueueProofEmpty(td::TlParser &p);
...
class tonNode_blockBroadcastCompressed_data final : public Object {
 public:
  std::vector<object_ptr<tonNode_blockSignature>> signatures_;
  td::BufferSlice proof_data_;

  tonNode_blockBroadcastCompressed_data();

  tonNode_blockBroadcastCompressed_data(std::vector<object_ptr<tonNode_blockSignature>> &&signatures_, td::BufferSlice &&proof_data_);

  static const std::int32_t ID = -24046666;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<tonNode_blockBroadcastCompressed_data> fetch(td::TlParser &p);

  explicit tonNode_blockBroadcastCompressed_data(td::TlParser &p);
...
class validator_telemetry final : public Object {
 public:
  std::int32_t flags_;
  double timestamp_;
  td::Bits256 adnl_id_;
  ...
  std::int32_t node_started_at_;
  std::int64_t ram_size_;
  std::int32_t cpu_cores_;
  std::int32_t node_threads_;

  validator_telemetry();

  validator_telemetry(std::int32_t flags_, double timestamp_, td::Bits256 const &adnl_id_, std::string const &node_version_, std::string const &os_version_, std::int32_t node_started_at_, std::int64_t ram_size_, std::int32_t cpu_cores_, std::int32_t node_threads_);

  static const std::int32_t ID = 1560508273;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validator_telemetry> fetch(td::TlParser &p);
...
class validatorSession_Candidate: public Object {
 public:

  static object_ptr<validatorSession_Candidate> fetch(td::TlParser &p);
};

class validatorSession_candidate final : public validatorSession_Candidate {
 public:
  td::Bits256 src_;
  std::int32_t round_;
  td::Bits256 root_hash_;
...
class validatorSession_compressedCandidate final : public validatorSession_Candidate {
 public:
  std::int32_t flags_;
  td::Bits256 src_;
  std::int32_t round_;
  ...
  validatorSession_compressedCandidate();

  validatorSession_compressedCandidate(std::int32_t flags_, td::Bits256 const &src_, std::int32_t round_, td::Bits256 const &root_hash_, std::int32_t decompressed_size_, td::BufferSlice &&data_);

  static const std::int32_t ID = 1108526967;
  std::int32_t get_id() const final {
    return ID;
  }
...
class validatorStats_collatedBlock final : public Object {
 public:
  object_ptr<tonNode_blockIdExt> block_id_;
  td::Bits256 collated_data_hash_;
  std::int32_t cc_seqno_;
  double collated_at_;
  std::int32_t bytes_;
  std::int32_t collated_data_bytes_;
  std::int32_t attempt_;
  td::Bits256 self_;
  bool is_validator_;
  double total_time_;
  double work_time_;
  double cpu_work_time_;
  std::string time_stats_;
  object_ptr<validatorStats_blockLimitsStatus> block_limits_;
  object_ptr<validatorStats_extMsgsStats> ext_msgs_stats_;

  validatorStats_collatedBlock();

  validatorStats_collatedBlock(object_ptr<tonNode_blockIdExt> &&block_id_, td::Bits256 const &collated_data_hash_, std::int32_t cc_seqno_, double collated_at_, std::int32_t bytes_, std::int32_t collated_data_bytes_, std::int32_t attempt_, td::Bits256 const &self_, bool is_validator_, double total_time_, double work_time_, double cpu_work_time_, std::string const &time_stats_, object_ptr<validatorStats_blockLimitsStatus> &&block_limits_, object_ptr<validatorStats_extMsgsStats> &&ext_msgs_stats_);

  static const std::int32_t ID = -316530976;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_collatedBlock> fetch(td::TlParser &p);

  explicit validatorStats_collatedBlock(td::TlParser &p);
...
class validatorStats_blockLimitsStatus final : public Object {
 public:
  std::int32_t bytes_;
  std::int32_t gas_;
  std::int32_t lt_delta_;
  std::int32_t collated_data_bytes_;
  std::int32_t cat_bytes_;
  std::int32_t cat_gas_;
  std::int32_t cat_lt_delta_;
  std::int32_t cat_collated_data_bytes_;
  std::string limits_log_;

  validatorStats_blockLimitsStatus();

  validatorStats_blockLimitsStatus(std::int32_t bytes_, std::int32_t gas_, std::int32_t lt_delta_, std::int32_t collated_data_bytes_, std::int32_t cat_bytes_, std::int32_t cat_gas_, std::int32_t cat_lt_delta_, std::int32_t cat_collated_data_bytes_, std::string const &limits_log_);

  static const std::int32_t ID = -1603837974;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_blockLimitsStatus> fetch(td::TlParser &p);

  explicit validatorStats_blockLimitsStatus(td::TlParser &p);
...
class validatorStats_collatorNodeResponse final : public Object {
 public:
  td::Bits256 self_;
  td::Bits256 validator_id_;
  double timestamp_;
  object_ptr<tonNode_blockIdExt> block_id_;
  object_ptr<tonNode_blockIdExt> original_block_id_;
  td::Bits256 collated_data_hash_;

  validatorStats_collatorNodeResponse();

  validatorStats_collatorNodeResponse(td::Bits256 const &self_, td::Bits256 const &validator_id_, double timestamp_, object_ptr<tonNode_blockIdExt> &&block_id_, object_ptr<tonNode_blockIdExt> &&original_block_id_, td::Bits256 const &collated_data_hash_);

  static const std::int32_t ID = 474244860;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_collatorNodeResponse> fetch(td::TlParser &p);

  explicit validatorStats_collatorNodeResponse(td::TlParser &p);
...
class validatorStats_endValidatorGroup final : public Object {
 public:
  td::Bits256 session_id_;
  double timestamp_;
  td::Bits256 self_;
  std::vector<object_ptr<validatorStats_endValidatorGroup_node>> nodes_;

  validatorStats_endValidatorGroup();

  validatorStats_endValidatorGroup(td::Bits256 const &session_id_, double timestamp_, td::Bits256 const &self_, std::vector<object_ptr<validatorStats_endValidatorGroup_node>> &&nodes_);

  static const std::int32_t ID = -1593008322;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_endValidatorGroup> fetch(td::TlParser &p);

  explicit validatorStats_endValidatorGroup(td::TlParser &p);
...
class validatorStats_extMsgsStats final : public Object {
 public:
  std::int32_t ext_msgs_total_;
  std::int32_t ext_msgs_filtered_;
  std::int32_t ext_msgs_accepted_;
  std::int32_t ext_msgs_rejected_;

  validatorStats_extMsgsStats();

  validatorStats_extMsgsStats(std::int32_t ext_msgs_total_, std::int32_t ext_msgs_filtered_, std::int32_t ext_msgs_accepted_, std::int32_t ext_msgs_rejected_);

  static const std::int32_t ID = 1803066447;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_extMsgsStats> fetch(td::TlParser &p);

  explicit validatorStats_extMsgsStats(td::TlParser &p);
...
class validatorStats_newValidatorGroup final : public Object {
 public:
  td::Bits256 session_id_;
  object_ptr<tonNode_shardId> shard_;
  std::int32_t cc_seqno_;
  std::int32_t last_key_block_seqno_;
  double started_at_;
  std::int32_t self_idx_;
  td::Bits256 self_;
  std::vector<object_ptr<validatorStats_newValidatorGroup_node>> nodes_;

  validatorStats_newValidatorGroup();

  validatorStats_newValidatorGroup(td::Bits256 const &session_id_, object_ptr<tonNode_shardId> &&shard_, std::int32_t cc_seqno_, std::int32_t last_key_block_seqno_, double started_at_, std::int32_t self_idx_, td::Bits256 const &self_, std::vector<object_ptr<validatorStats_newValidatorGroup_node>> &&nodes_);

  static const std::int32_t ID = -1914588615;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_newValidatorGroup> fetch(td::TlParser &p);

  explicit validatorStats_newValidatorGroup(td::TlParser &p);
...
class validatorStats_stats final : public Object {
 public:
  std::int32_t flags_;
  td::Bits256 session_id_;
  td::Bits256 self_;
  ...
  std::vector<object_ptr<validatorStats_stats_round>> rounds_;
  enum Flags : std::int32_t {CREATOR_MASK = 1, SIGNATURES_MASK = 1, SIGNATURES_WEIGHT_MASK = 1, APPROVE_SIGNATURES_MASK = 1, APPROVE_SIGNATURES_WEIGHT_MASK = 1};

  validatorStats_stats();

  validatorStats_stats(std::int32_t flags_, td::Bits256 const &session_id_, td::Bits256 const &self_, object_ptr<tonNode_blockIdExt> &&block_id_, std::int32_t cc_seqno_, bool success_, double timestamp_, td::Bits256 const &creator_, std::int32_t total_validators_, std::int64_t total_weight_, std::int32_t signatures_, std::int64_t signatures_weight_, std::int32_t approve_signatures_, std::int64_t approve_signatures_weight_, std::int32_t first_round_, std::vector<object_ptr<validatorStats_stats_round>> &&rounds_);

  static const std::int32_t ID = 1157091964;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_stats> fetch(td::TlParser &p);
...
class validatorStats_validatedBlock final : public Object {
 public:
  object_ptr<tonNode_blockIdExt> block_id_;
  td::Bits256 collated_data_hash_;
  double validated_at_;
  td::Bits256 self_;
  bool valid_;
  std::string comment_;
  std::int32_t bytes_;
  ...
  validatorStats_validatedBlock(object_ptr<tonNode_blockIdExt> &&block_id_, td::Bits256 const &collated_data_hash_, double validated_at_, td::Bits256 const &self_, bool valid_, std::string const &comment_, std::int32_t bytes_, std::int32_t collated_data_bytes_, double total_time_, double work_time_, double cpu_work_time_);

  static const std::int32_t ID = 1396250433;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_validatedBlock> fetch(td::TlParser &p);

  explicit validatorStats_validatedBlock(td::TlParser &p);
...
class validatorStats_endValidatorGroup_node final : public Object {
 public:
  td::Bits256 id_;
  std::int32_t catchain_blocks_;

  validatorStats_endValidatorGroup_node();

  validatorStats_endValidatorGroup_node(td::Bits256 const &id_, std::int32_t catchain_blocks_);

  static const std::int32_t ID = 2048931237;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_endValidatorGroup_node> fetch(td::TlParser &p);

  explicit validatorStats_endValidatorGroup_node(td::TlParser &p);
...
class validatorStats_newValidatorGroup_node final : public Object {
 public:
  td::Bits256 id_;
  object_ptr<PublicKey> pubkey_;
  td::Bits256 adnl_id_;
  ...
  validatorStats_newValidatorGroup_node();

  validatorStats_newValidatorGroup_node(td::Bits256 const &id_, object_ptr<PublicKey> &&pubkey_, td::Bits256 const &adnl_id_, std::int64_t weight_);

  static const std::int32_t ID = -1138988284;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_newValidatorGroup_node> fetch(td::TlParser &p);

  explicit validatorStats_newValidatorGroup_node(td::TlParser &p);
...
class validatorStats_stats_producer final : public Object {
 public:
  std::int32_t flags_;
  td::Bits256 validator_id_;
  std::int32_t block_status_;
  td::Bits256 candidate_id_;
  object_ptr<tonNode_blockIdExt> block_id_;
  td::Bits256 collated_data_hash_;
  bool is_accepted_;
  bool is_ours_;
  double got_block_at_;
  double got_submit_at_;
  std::int32_t gen_utime_;
  std::string comment_;
  double collation_time_;
  double collated_at_;
  bool collation_cached_;
  bool self_collated_;
  td::Bits256 collator_node_id_;
  double validation_time_;
  double validated_at_;
  bool validation_cached_;
  std::int64_t approved_weight_;
  double approved_33pct_at_;
  double approved_66pct_at_;
  std::string approvers_;
  std::int64_t signed_weight_;
  double signed_33pct_at_;
  double signed_66pct_at_;
  std::string signers_;
  double serialize_time_;
  double deserialize_time_;
  std::int32_t serialized_size_;
  enum Flags : std::int32_t {CANDIDATE_ID_MASK = 1, BLOCK_ID_MASK = 1, COLLATED_DATA_HASH_MASK = 1, IS_ACCEPTED_MASK = 1, IS_OURS_MASK = 1, GOT_BLOCK_AT_MASK = 1, GOT_SUBMIT_AT_MASK = 1, GEN_UTIME_MASK = 1, COMMENT_MASK = 1, COLLATION_TIME_MASK = 2, COLLATED_AT_MASK = 2, COLLATION_CACHED_MASK = 2, SELF_COLLATED_MASK = 2, COLLATOR_NODE_ID_MASK = 4, VALIDATION_TIME_MASK = 8, VALIDATED_AT_MASK = 8, VALIDATION_CACHED_MASK = 8, APPROVED_WEIGHT_MASK = 1, APPROVED_33PCT_AT_MASK = 1, APPROVED_66PCT_AT_MASK = 1, APPROVERS_MASK = 1, SIGNED_WEIGHT_MASK = 1, SIGNED_33PCT_AT_MASK = 1, SIGNED_66PCT_AT_MASK = 1, SIGNERS_MASK = 1, SERIALIZE_TIME_MASK = 16, DESERIALIZE_TIME_MASK = 16, SERIALIZED_SIZE_MASK = 16};

  validatorStats_stats_producer();

  validatorStats_stats_producer(std::int32_t flags_, td::Bits256 const &validator_id_, std::int32_t block_status_, td::Bits256 const &candidate_id_, object_ptr<tonNode_blockIdExt> &&block_id_, td::Bits256 const &collated_data_hash_, bool is_accepted_, bool is_ours_, double got_block_at_, double got_submit_at_, std::int32_t gen_utime_, std::string const &comment_, double collation_time_, double collated_at_, bool collation_cached_, bool self_collated_, td::Bits256 const &collator_node_id_, double validation_time_, double validated_at_, bool validation_cached_, std::int64_t approved_weight_, double approved_33pct_at_, double approved_66pct_at_, std::string const &approvers_, std::int64_t signed_weight_, double signed_33pct_at_, double signed_66pct_at_, std::string const &signers_, double serialize_time_, double deserialize_time_, std::int32_t serialized_size_);

  static const std::int32_t ID = -1121712627;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_stats_producer> fetch(td::TlParser &p);
...
class validatorStats_stats_round final : public Object {
 public:
  double started_at_;
  std::vector<object_ptr<validatorStats_stats_producer>> producers_;

  validatorStats_stats_round();

  validatorStats_stats_round(double started_at_, std::vector<object_ptr<validatorStats_stats_producer>> &&producers_);

  static const std::int32_t ID = 620582254;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorStats_stats_round> fetch(td::TlParser &p);

  explicit validatorStats_stats_round(td::TlParser &p);
...
class collatorNode_generateBlock final : public Function {
 public:
  object_ptr<tonNode_shardId> shard_;
  std::int32_t cc_seqno_;
  ...
  td::Bits256 creator_;
  std::int32_t round_;
  std::int32_t first_block_round_;
  std::int32_t priority_;

  collatorNode_generateBlock();

  collatorNode_generateBlock(object_ptr<tonNode_shardId> &&shard_, std::int32_t cc_seqno_, std::vector<object_ptr<tonNode_blockIdExt>> &&prev_blocks_, td::Bits256 const &creator_, std::int32_t round_, std::int32_t first_block_round_, std::int32_t priority_);

  static const std::int32_t ID = -464047564;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<collatorNode_Candidate>;

  static object_ptr<collatorNode_generateBlock> fetch(td::TlParser &p);

  explicit collatorNode_generateBlock(td::TlParser &p);
...
class collatorNode_ping final : public Function {
 public:
  std::int32_t flags_;
  ...
  explicit collatorNode_ping(std::int32_t flags_);

  static const std::int32_t ID = 2112845767;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<collatorNode_pong>;

  static object_ptr<collatorNode_ping> fetch(td::TlParser &p);
...
class engine_validator_addCollator final : public Function {
 public:
  td::Bits256 adnl_id_;
  object_ptr<tonNode_shardId> shard_;

  engine_validator_addCollator();

  engine_validator_addCollator(td::Bits256 const &adnl_id_, object_ptr<tonNode_shardId> &&shard_);

  static const std::int32_t ID = -1633025000;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_addCollator> fetch(td::TlParser &p);

  explicit engine_validator_addCollator(td::TlParser &p);
...
class engine_validator_addCustomOverlay final : public Function {
 public:
  object_ptr<engine_validator_customOverlay> overlay_;

  engine_validator_addCustomOverlay();

  explicit engine_validator_addCustomOverlay(object_ptr<engine_validator_customOverlay> &&overlay_);

  static const std::int32_t ID = 994042376;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_addCustomOverlay> fetch(td::TlParser &p);

  explicit engine_validator_addCustomOverlay(td::TlParser &p);
...
class engine_validator_addFastSyncClient final : public Function {
 public:
  td::Bits256 adnl_id_;
  std::int32_t slot_;

  engine_validator_addFastSyncClient();

  engine_validator_addFastSyncClient(td::Bits256 const &adnl_id_, std::int32_t slot_);

  static const std::int32_t ID = 1412546423;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_addFastSyncClient> fetch(td::TlParser &p);

  explicit engine_validator_addFastSyncClient(td::TlParser &p);
...
class engine_validator_addShard final : public Function {
 public:
  object_ptr<tonNode_shardId> shard_;

  engine_validator_addShard();

  explicit engine_validator_addShard(object_ptr<tonNode_shardId> &&shard_);

  static const std::int32_t ID = -472752039;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_addShard> fetch(td::TlParser &p);

  explicit engine_validator_addShard(td::TlParser &p);
...
class engine_validator_clearCollatorsList final : public Function {
 public:

  engine_validator_clearCollatorsList();

  static const std::int32_t ID = -957042098;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_clearCollatorsList> fetch(td::TlParser &p);

  explicit engine_validator_clearCollatorsList(td::TlParser &p);
...
class engine_validator_collatorNodeSetWhitelistEnabled final : public Function {
 public:
  bool enabled_;

  engine_validator_collatorNodeSetWhitelistEnabled();

  explicit engine_validator_collatorNodeSetWhitelistEnabled(bool enabled_);

  static const std::int32_t ID = -136165035;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_collatorNodeSetWhitelistEnabled> fetch(td::TlParser &p);

  explicit engine_validator_collatorNodeSetWhitelistEnabled(td::TlParser &p);
...
class engine_validator_collatorNodeSetWhitelistedValidator final : public Function {
 public:
  td::Bits256 adnl_id_;
  bool add_;

  engine_validator_collatorNodeSetWhitelistedValidator();

  engine_validator_collatorNodeSetWhitelistedValidator(td::Bits256 const &adnl_id_, bool add_);

  static const std::int32_t ID = 365758025;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_collatorNodeSetWhitelistedValidator> fetch(td::TlParser &p);

  explicit engine_validator_collatorNodeSetWhitelistedValidator(td::TlParser &p);
...
class engine_validator_delCollator final : public Function {
 public:
  td::Bits256 adnl_id_;
  object_ptr<tonNode_shardId> shard_;

  engine_validator_delCollator();

  engine_validator_delCollator(td::Bits256 const &adnl_id_, object_ptr<tonNode_shardId> &&shard_);

  static const std::int32_t ID = 293914972;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_delCollator> fetch(td::TlParser &p);

  explicit engine_validator_delCollator(td::TlParser &p);
...
class engine_validator_delCustomOverlay final : public Function {
 public:
  std::string name_;

  engine_validator_delCustomOverlay();

  explicit engine_validator_delCustomOverlay(std::string const &name_);

  static const std::int32_t ID = 2034844268;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_delCustomOverlay> fetch(td::TlParser &p);

  explicit engine_validator_delCustomOverlay(td::TlParser &p);
...
class engine_validator_delFastSyncClient final : public Function {
 public:
  td::Bits256 adnl_id_;

  engine_validator_delFastSyncClient();

  explicit engine_validator_delFastSyncClient(td::Bits256 const &adnl_id_);

  static const std::int32_t ID = -301475743;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_delFastSyncClient> fetch(td::TlParser &p);

  explicit engine_validator_delFastSyncClient(td::TlParser &p);
...
class engine_validator_delShard final : public Function {
 public:
  object_ptr<tonNode_shardId> shard_;

  engine_validator_delShard();

  explicit engine_validator_delShard(object_ptr<tonNode_shardId> &&shard_);

  static const std::int32_t ID = 1328182971;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_delShard> fetch(td::TlParser &p);

  explicit engine_validator_delShard(td::TlParser &p);
...
class engine_validator_exportAllPrivateKeys final : public Function {
 public:
  object_ptr<PublicKey> encryption_key_;

  engine_validator_exportAllPrivateKeys();

  explicit engine_validator_exportAllPrivateKeys(object_ptr<PublicKey> &&encryption_key_);

  static const std::int32_t ID = -849980430;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<engine_validator_exportedPrivateKeys>;

  static object_ptr<engine_validator_exportAllPrivateKeys> fetch(td::TlParser &p);

  explicit engine_validator_exportAllPrivateKeys(td::TlParser &p);
...
class engine_validator_getActorTextStats final : public Function {
 public:

  engine_validator_getActorTextStats();

  static const std::int32_t ID = 1755376848;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<engine_validator_textStats>;

  static object_ptr<engine_validator_getActorTextStats> fetch(td::TlParser &p);

  explicit engine_validator_getActorTextStats(td::TlParser &p);
...
class engine_validator_getAdnlStats final : public Function {
 public:
  bool all_;

  engine_validator_getAdnlStats();

  explicit engine_validator_getAdnlStats(bool all_);

  static const std::int32_t ID = -1818239261;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<adnl_stats>;

  static object_ptr<engine_validator_getAdnlStats> fetch(td::TlParser &p);

  explicit engine_validator_getAdnlStats(td::TlParser &p);
...
class engine_validator_getCollationManagerStats final : public Function {
 public:

  engine_validator_getCollationManagerStats();

  static const std::int32_t ID = -430816772;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<engine_validator_collationManagerStats>;

  static object_ptr<engine_validator_getCollationManagerStats> fetch(td::TlParser &p);

  explicit engine_validator_getCollationManagerStats(td::TlParser &p);
...
class engine_validator_getCollatorOptionsJson final : public Function {
 public:

  engine_validator_getCollatorOptionsJson();

  static const std::int32_t ID = 1279450873;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_getCollatorOptionsJson> fetch(td::TlParser &p);

  explicit engine_validator_getCollatorOptionsJson(td::TlParser &p);
...
class engine_validator_importFastSyncMemberCertificate final : public Function {
 public:
  td::Bits256 adnl_id_;
  object_ptr<overlay_MemberCertificate> certificate_;

  engine_validator_importFastSyncMemberCertificate();

  engine_validator_importFastSyncMemberCertificate(td::Bits256 const &adnl_id_, object_ptr<overlay_MemberCertificate> &&certificate_);

  static const std::int32_t ID = 365076401;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_importFastSyncMemberCertificate> fetch(td::TlParser &p);

  explicit engine_validator_importFastSyncMemberCertificate(td::TlParser &p);
...
class engine_validator_setCollatorOptionsJson final : public Function {
 public:
  std::string json_;

  engine_validator_setCollatorOptionsJson();

  explicit engine_validator_setCollatorOptionsJson(std::string const &json_);

  static const std::int32_t ID = 1503354240;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_setCollatorOptionsJson> fetch(td::TlParser &p);

  explicit engine_validator_setCollatorOptionsJson(td::TlParser &p);
...
class engine_validator_setCollatorsList final : public Function {
 public:
  object_ptr<engine_validator_collatorsList> list_;

  engine_validator_setCollatorsList();

  explicit engine_validator_setCollatorsList(object_ptr<engine_validator_collatorsList> &&list_);

  static const std::int32_t ID = 1500768396;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_setCollatorsList> fetch(td::TlParser &p);

  explicit engine_validator_setCollatorsList(td::TlParser &p);
...
class engine_validator_setStateSerializerEnabled final : public Function {
 public:
  bool enabled_;

  engine_validator_setStateSerializerEnabled();

  explicit engine_validator_setStateSerializerEnabled(bool enabled_);

  static const std::int32_t ID = 2057046485;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_setStateSerializerEnabled> fetch(td::TlParser &p);

  explicit engine_validator_setStateSerializerEnabled(td::TlParser &p);
...
class engine_validator_showCollatorNodeWhitelist final : public Function {
 public:

  engine_validator_showCollatorNodeWhitelist();

  static const std::int32_t ID = -2141136903;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<engine_validator_collatorNodeWhitelist>;

  static object_ptr<engine_validator_showCollatorNodeWhitelist> fetch(td::TlParser &p);

  explicit engine_validator_showCollatorNodeWhitelist(td::TlParser &p);
...
class engine_validator_showCollatorsList final : public Function {
 public:

  engine_validator_showCollatorsList();

  static const std::int32_t ID = 801133077;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<engine_validator_collatorsList>;

  static object_ptr<engine_validator_showCollatorsList> fetch(td::TlParser &p);

  explicit engine_validator_showCollatorsList(td::TlParser &p);
...
class engine_validator_showCustomOverlays final : public Function {
 public:

  engine_validator_showCustomOverlays();

  static const std::int32_t ID = -1186851525;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<engine_validator_customOverlaysConfig>;

  static object_ptr<engine_validator_showCustomOverlays> fetch(td::TlParser &p);

  explicit engine_validator_showCustomOverlays(td::TlParser &p);
...
class engine_validator_signOverlayMemberCertificate final : public Function {
 public:
  td::Bits256 sign_by_;
  td::Bits256 adnl_id_;
  std::int32_t slot_;
  ...
  engine_validator_signOverlayMemberCertificate();

  engine_validator_signOverlayMemberCertificate(td::Bits256 const &sign_by_, td::Bits256 const &adnl_id_, std::int32_t slot_, std::int32_t expire_at_);

  static const std::int32_t ID = 1098167522;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<overlay_MemberCertificate>;

  static object_ptr<engine_validator_signOverlayMemberCertificate> fetch(td::TlParser &p);

  explicit engine_validator_signOverlayMemberCertificate(td::TlParser &p);
...
class overlay_getRandomPeersV2 final : public Function {
 public:
  object_ptr<overlay_nodesV2> peers_;

  overlay_getRandomPeersV2();

  explicit overlay_getRandomPeersV2(object_ptr<overlay_nodesV2> &&peers_);

  static const std::int32_t ID = 362819600;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<overlay_nodesV2>;

  static object_ptr<overlay_getRandomPeersV2> fetch(td::TlParser &p);

  explicit overlay_getRandomPeersV2(td::TlParser &p);
...
class overlay_queryWithExtra final : public Function {
 public:
  td::Bits256 overlay_;
  object_ptr<overlay_messageExtra> extra_;

  overlay_queryWithExtra();

  overlay_queryWithExtra(td::Bits256 const &overlay_, object_ptr<overlay_messageExtra> &&extra_);

  static const std::int32_t ID = -1795177495;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<overlay_queryWithExtra> fetch(td::TlParser &p);

  explicit overlay_queryWithExtra(td::TlParser &p);
...
class tonNode_getOutMsgQueueProof final : public Function {
 public:
  object_ptr<tonNode_shardId> dst_shard_;
  std::vector<object_ptr<tonNode_blockIdExt>> blocks_;
  object_ptr<tonNode_importedMsgQueueLimits> limits_;

  tonNode_getOutMsgQueueProof();

  tonNode_getOutMsgQueueProof(object_ptr<tonNode_shardId> &&dst_shard_, std::vector<object_ptr<tonNode_blockIdExt>> &&blocks_, object_ptr<tonNode_importedMsgQueueLimits> &&limits_);

  static const std::int32_t ID = -2075371231;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<tonNode_OutMsgQueueProof>;

  static object_ptr<tonNode_getOutMsgQueueProof> fetch(td::TlParser &p);

  explicit tonNode_getOutMsgQueueProof(td::TlParser &p);
...
class tonNode_getShardArchiveInfo final : public Function {
 public:
  std::int32_t masterchain_seqno_;
  object_ptr<tonNode_shardId> shard_prefix_;

  tonNode_getShardArchiveInfo();

  tonNode_getShardArchiveInfo(std::int32_t masterchain_seqno_, object_ptr<tonNode_shardId> &&shard_prefix_);

  static const std::int32_t ID = 318454616;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<tonNode_getShardArchiveInfo> fetch(td::TlParser &p);

  explicit tonNode_getShardArchiveInfo(td::TlParser &p);
...
class tonNode_requestFastSyncOverlayMemberCertificate final : public Function {
 public:
  td::Bits256 sign_by_;
  td::Bits256 adnl_id_;
  std::int32_t slot_;

  tonNode_requestFastSyncOverlayMemberCertificate();

  tonNode_requestFastSyncOverlayMemberCertificate(td::Bits256 const &sign_by_, td::Bits256 const &adnl_id_, std::int32_t slot_);

  static const std::int32_t ID = 1429729957;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<tonNode_requestFastSyncOverlayMemberCertificate> fetch(td::TlParser &p);

  explicit tonNode_requestFastSyncOverlayMemberCertificate(td::TlParser &p);
