...
class blocks_outMsgQueueSize;

class blocks_outMsgQueueSizes;
...
class extraCurrency final : public Object {
 public:
  std::int32_t id_;
  std::int64_t amount_;
  ...
  extraCurrency(std::int32_t id_, std::int64_t amount_);

  static const std::int32_t ID = 347022801;
  std::int32_t get_id() const final {
    return ID;
  }
...
class fullAccountState final : public Object {
 public:
  ...
  std::vector<object_ptr<extraCurrency>> extra_currencies_;
...
class blocks_outMsgQueueSize final : public Object {
 public:
  object_ptr<ton_blockIdExt> id_;
  std::int32_t size_;

  blocks_outMsgQueueSize();

  blocks_outMsgQueueSize(object_ptr<ton_blockIdExt> &&id_, std::int32_t size_);

  static const std::int32_t ID = 1650494287;
  std::int32_t get_id() const final {
    return ID;
  }
...
class blocks_outMsgQueueSizes final : public Object {
 public:
  std::vector<object_ptr<blocks_outMsgQueueSize>> shards_;
  std::int32_t ext_msg_queue_size_limit_;

  blocks_outMsgQueueSizes();

  blocks_outMsgQueueSizes(std::vector<object_ptr<blocks_outMsgQueueSize>> &&shards_, std::int32_t ext_msg_queue_size_limit_);

  static const std::int32_t ID = -586969790;
  std::int32_t get_id() const final {
    return ID;
  }
...
class msg_message final : public Object {
 public:
  ...
  msg_message(object_ptr<accountAddress> &&destination_, std::string const &public_key_, std::int64_t amount_, std::vector<object_ptr<extraCurrency>> &&extra_currencies_, object_ptr<msg_Data> &&data_, std::int32_t send_mode_);

  static const std::int32_t ID = -1652961002;
  std::int32_t get_id() const final {
    return ID;
  }
...
class raw_fullAccountState final : public Object {
 public:
  ...
  raw_fullAccountState(std::int64_t balance_, std::vector<object_ptr<extraCurrency>> &&extra_currencies_, std::string const &code_, std::string const &data_, object_ptr<internal_transactionId> &&last_transaction_id_, object_ptr<ton_blockIdExt> &&block_id_, std::string const &frozen_hash_, std::int64_t sync_utime_);

  static const std::int32_t ID = -1002565503;
  std::int32_t get_id() const final {
    return ID;
  }
...
class blocks_getOutMsgQueueSizes final : public Function {
 public:
  std::int32_t mode_;
  std::int32_t wc_;
  std::int64_t shard_;
  ...
  blocks_getOutMsgQueueSizes();

  blocks_getOutMsgQueueSizes(std::int32_t mode_, std::int32_t wc_, std::int64_t shard_);

  static const std::int32_t ID = -1187352660;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<blocks_outMsgQueueSizes>;
...
class smc_getRawFullAccountState final : public Function {
 public:
  std::int64_t id_;

  smc_getRawFullAccountState();

  explicit smc_getRawFullAccountState(std::int64_t id_);

  static const std::int32_t ID = -672334072;
  std::int32_t get_id() const final {
    return ID;
  }
