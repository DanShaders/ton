...
td::actor::Task<> AdnlPeerTableImpl::collect(metrics::Context ctx) {
  ...
  metrics_.transport->local_ids.set(static_cast<double>(local_ids_.size()));
  metrics_.transport->peers.set(static_cast<double>(peers_.size()));
  metrics_.transport->peer_pairs.set(static_cast<double>(peer_pairs));
  metrics_.transport->channels.set(static_cast<double>(channels_.size()));
  metrics_.transport->static_nodes.set(static_cast<double>(static_nodes_.size()));
