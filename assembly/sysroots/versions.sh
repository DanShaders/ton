...
WINDOWS_CRT_VERSION=14.44.17.14

# ===== crc32c (downloaded so we can patch it for clang-cl/MSVC simulation) =====
CRC32C_VERSION=1.1.2
CRC32C_URL="https://github.com/google/crc32c/archive/refs/tags/${CRC32C_VERSION}.tar.gz"
CRC32C_SHA256="ac07840513072b7fcebda6e821068aa04889018f24e10e46181068fb214d7e56"
