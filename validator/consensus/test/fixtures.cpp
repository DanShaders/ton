...
td::Bits256 sha256_bits256(td::Slice data) {
  td::Bits256 hash;
...
ChainStateRef make_normal_state(ShardIdFull shard, BlockSeqno seqno, BlockIdExt mc_block_id) {
  ...
  BlockIdExt id(BlockId(shard, seqno), td::Bits256(cell->get_hash().bits()), sha256_bits256(data));
...
CandidateBundle make_candidate_bundle(const consensus::Bus& bus, td::Span<PrivateKey> keys, td::uint32 slot) {
  ...
  td::Bits256 block_data_hash = sha256_bits256(block_data.as_slice());
  td::Bits256 root_hash = bits256(0x1F);
  td::Bits256 collated_data_hash = sha256_bits256(collated_data.as_slice());
