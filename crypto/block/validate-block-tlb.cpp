...
int main(int argc, char** argv) {
  ...
  bench("gen::t_Block.validate_ref", N, [&] {
    return block::gen::t_Block.validate_ref(10000000, block_root);
  });

  // 2. Handwritten InMsgDescr validation (block::tlb::)
  block::tlb::InMsgDescr t_InMsgDescr{0};
  bench("tlb::InMsgDescr.validate_upto", N, [&] {
    return t_InMsgDescr.validate_upto(10000000, *inmsg_cs);
  });

  // 3. Handwritten OutMsgDescr validation (block::tlb::)
  block::tlb::OutMsgDescr t_OutMsgDescr{0};
  bench("tlb::OutMsgDescr.validate_upto", N, [&] {
    return t_OutMsgDescr.validate_upto(10000000, *outmsg_cs);
  });
