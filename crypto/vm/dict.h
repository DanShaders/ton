...
class DictionaryFixed : public DictionaryBase {
 public:
  ...
  typedef std::function<bool()> light_no_params_foreach_func_t;
  typedef std::function<bool(unsigned long long , int)> uint15Bits_light_foreach_func_t; // unsigned long long  is uint15bit of key -> key.get_uint(15)
  ...
  bool check_for_each_light(const uint15Bits_light_foreach_func_t& foreach_func, bool invert_first = false, bool shuffle = false);
  bool check_for_each(const foreach_func_t& foreach_func, bool invert_first = false, bool shuffle = false);
  bool check_for_each_light(const light_no_params_foreach_func_t& foreach_func); // , bool invert_first = false, bool shuffle = false
 ...
 private:
  ...
  bool dict_check_for_each_light(Ref<Cell> dict, td::BitPtr key_buffer, int n, int total_key_len,
                           const uint15Bits_light_foreach_func_t& foreach_func) const;
  ...
  bool dict_check_for_each_light(Ref<Cell> dict, td::BitPtr key_buffer, int n,
                                 const light_no_params_foreach_func_t& foreach_func) const;
