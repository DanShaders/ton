...
struct CellStorageStat {
  ...
  template<bool kill_dup = true, unsigned skip_count_root = 0>
  td::Result<CellInfo> add_used_storage(Ref<vm::CellSlice> cs_ref);
  template<bool kill_dup = true, unsigned skip_count_root = 0>
  td::Result<CellInfo> add_used_storage(const CellSlice& cs);
  template<bool kill_dup = true, unsigned skip_count_root = 0>
  td::Result<CellInfo> add_used_storage(CellSlice&& cs);
  template<bool kill_dup = true, unsigned skip_count_root = 0>
  td::Result<CellInfo> add_used_storage(Ref<vm::Cell> cell, CellUsageTree::NodePtr tree_node = {});
