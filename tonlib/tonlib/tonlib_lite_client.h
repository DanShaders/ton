...
//
// `config` should be a JSON-encoded `liteClient.config` object. If creation of the
// instance fails, the error can be obtained from `tonlib_lite_client_is_error` and
// related functions.
